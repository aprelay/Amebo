var Ir=Object.defineProperty;var $e=e=>{throw TypeError(e)};var Dr=(e,r,t)=>r in e?Ir(e,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[r]=t;var y=(e,r,t)=>Dr(e,typeof r!="symbol"?r+"":r,t),Me=(e,r,t)=>r.has(e)||$e("Cannot "+t);var l=(e,r,t)=>(Me(e,r,"read from private field"),t?t.call(e):r.get(e)),w=(e,r,t)=>r.has(e)?$e("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,t),g=(e,r,t,s)=>(Me(e,r,"write to private field"),s?s.call(e,t):r.set(e,t),t),b=(e,r,t)=>(Me(e,r,"access private method"),t);var Ve=(e,r,t,s)=>({set _(n){g(e,r,n,t)},get _(){return l(e,r,s)}});var Ge=(e,r,t)=>(s,n)=>{let a=-1;return o(0);async function o(i){if(i<=a)throw new Error("next() called multiple times");a=i;let u,d=!1,c;if(e[i]?(c=e[i][0][0],s.req.routeIndex=i):c=i===e.length&&n||void 0,c)try{u=await c(s,()=>o(i+1))}catch(m){if(m instanceof Error&&r)s.error=m,u=await r(m,s),d=!0;else throw m}else s.finalized===!1&&t&&(u=await t(s));return u&&(s.finalized===!1||d)&&(s.res=u),s}},Sr=Symbol(),jr=async(e,r=Object.create(null))=>{const{all:t=!1,dot:s=!1}=r,a=(e instanceof dr?e.raw.headers:e.headers).get("Content-Type");return a!=null&&a.startsWith("multipart/form-data")||a!=null&&a.startsWith("application/x-www-form-urlencoded")?Ar(e,{all:t,dot:s}):{}};async function Ar(e,r){const t=await e.formData();return t?Or(t,r):{}}function Or(e,r){const t=Object.create(null);return e.forEach((s,n)=>{r.all||n.endsWith("[]")?kr(t,n,s):t[n]=s}),r.dot&&Object.entries(t).forEach(([s,n])=>{s.includes(".")&&(Cr(t,s,n),delete t[s])}),t}var kr=(e,r,t)=>{e[r]!==void 0?Array.isArray(e[r])?e[r].push(t):e[r]=[e[r],t]:r.endsWith("[]")?e[r]=[t]:e[r]=t},Cr=(e,r,t)=>{let s=e;const n=r.split(".");n.forEach((a,o)=>{o===n.length-1?s[a]=t:((!s[a]||typeof s[a]!="object"||Array.isArray(s[a])||s[a]instanceof File)&&(s[a]=Object.create(null)),s=s[a])})},sr=e=>{const r=e.split("/");return r[0]===""&&r.shift(),r},Nr=e=>{const{groups:r,path:t}=Ur(e),s=sr(t);return Lr(s,r)},Ur=e=>{const r=[];return e=e.replace(/\{[^}]+\}/g,(t,s)=>{const n=`@${s}`;return r.push([n,t]),n}),{groups:r,path:e}},Lr=(e,r)=>{for(let t=r.length-1;t>=0;t--){const[s]=r[t];for(let n=e.length-1;n>=0;n--)if(e[n].includes(s)){e[n]=e[n].replace(s,r[t][1]);break}}return e},Oe={},xr=(e,r)=>{if(e==="*")return"*";const t=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(t){const s=`${e}#${r}`;return Oe[s]||(t[2]?Oe[s]=r&&r[0]!==":"&&r[0]!=="*"?[s,t[1],new RegExp(`^${t[2]}(?=/${r})`)]:[e,t[1],new RegExp(`^${t[2]}$`)]:Oe[s]=[e,t[1],!0]),Oe[s]}return null},We=(e,r)=>{try{return r(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,t=>{try{return r(t)}catch{return t}})}},Pr=e=>We(e,decodeURI),nr=e=>{const r=e.url,t=r.indexOf("/",r.indexOf(":")+4);let s=t;for(;s<r.length;s++){const n=r.charCodeAt(s);if(n===37){const a=r.indexOf("?",s),o=r.slice(t,a===-1?void 0:a);return Pr(o.includes("%25")?o.replace(/%25/g,"%2525"):o)}else if(n===63)break}return r.slice(t,s)},Mr=e=>{const r=nr(e);return r.length>1&&r.at(-1)==="/"?r.slice(0,-1):r},le=(e,r,...t)=>(t.length&&(r=le(r,...t)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${r==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(r==null?void 0:r[0])==="/"?r.slice(1):r}`}`),ar=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const r=e.split("/"),t=[];let s="";return r.forEach(n=>{if(n!==""&&!/\:/.test(n))s+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){t.length===0&&s===""?t.push("/"):t.push(s);const a=n.replace("?","");s+="/"+a,t.push(s)}else s+="/"+n}),t.filter((n,a,o)=>o.indexOf(n)===a)},Fe=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?We(e,ir):e):e,or=(e,r,t)=>{let s;if(!t&&r&&!/[%+]/.test(r)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(r,o+1)||(o=e.indexOf(`&${r}`,o+1));o!==-1;){const i=e.charCodeAt(o+r.length+1);if(i===61){const u=o+r.length+2,d=e.indexOf("&",u);return Fe(e.slice(u,d===-1?void 0:d))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${r}`,o+1)}if(s=/[%+]/.test(e),!s)return}const n={};s??(s=/[%+]/.test(e));let a=e.indexOf("?",8);for(;a!==-1;){const o=e.indexOf("&",a+1);let i=e.indexOf("=",a);i>o&&o!==-1&&(i=-1);let u=e.slice(a+1,i===-1?o===-1?void 0:o:i);if(s&&(u=Fe(u)),a=o,u==="")continue;let d;i===-1?d="":(d=e.slice(i+1,o===-1?void 0:o),s&&(d=Fe(d))),t?(n[u]&&Array.isArray(n[u])||(n[u]=[]),n[u].push(d)):n[u]??(n[u]=d)}return r?n[r]:n},Fr=or,Br=(e,r)=>or(e,r,!0),ir=decodeURIComponent,Ye=e=>We(e,ir),fe,P,G,ur,cr,He,Y,Xe,dr=(Xe=class{constructor(e,r="/",t=[[]]){w(this,G);y(this,"raw");w(this,fe);w(this,P);y(this,"routeIndex",0);y(this,"path");y(this,"bodyCache",{});w(this,Y,e=>{const{bodyCache:r,raw:t}=this,s=r[e];if(s)return s;const n=Object.keys(r)[0];return n?r[n].then(a=>(n==="json"&&(a=JSON.stringify(a)),new Response(a)[e]())):r[e]=t[e]()});this.raw=e,this.path=r,g(this,P,t),g(this,fe,{})}param(e){return e?b(this,G,ur).call(this,e):b(this,G,cr).call(this)}query(e){return Fr(this.url,e)}queries(e){return Br(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const r={};return this.raw.headers.forEach((t,s)=>{r[s]=t}),r}async parseBody(e){var r;return(r=this.bodyCache).parsedBody??(r.parsedBody=await jr(this,e))}json(){return l(this,Y).call(this,"text").then(e=>JSON.parse(e))}text(){return l(this,Y).call(this,"text")}arrayBuffer(){return l(this,Y).call(this,"arrayBuffer")}blob(){return l(this,Y).call(this,"blob")}formData(){return l(this,Y).call(this,"formData")}addValidatedData(e,r){l(this,fe)[e]=r}valid(e){return l(this,fe)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Sr](){return l(this,P)}get matchedRoutes(){return l(this,P)[0].map(([[,e]])=>e)}get routePath(){return l(this,P)[0].map(([[,e]])=>e)[this.routeIndex].path}},fe=new WeakMap,P=new WeakMap,G=new WeakSet,ur=function(e){const r=l(this,P)[0][this.routeIndex][1][e],t=b(this,G,He).call(this,r);return t&&/\%/.test(t)?Ye(t):t},cr=function(){const e={},r=Object.keys(l(this,P)[0][this.routeIndex][1]);for(const t of r){const s=b(this,G,He).call(this,l(this,P)[0][this.routeIndex][1][t]);s!==void 0&&(e[t]=/\%/.test(s)?Ye(s):s)}return e},He=function(e){return l(this,P)[1]?l(this,P)[1][e]:e},Y=new WeakMap,Xe),Hr={Stringify:1},lr=async(e,r,t,s,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const a=e.callbacks;return a!=null&&a.length?(n?n[0]+=e:n=[e],Promise.all(a.map(i=>i({phase:r,buffer:n,context:s}))).then(i=>Promise.all(i.filter(Boolean).map(u=>lr(u,r,!1,s,n))).then(()=>n[0]))):Promise.resolve(e)},qr="text/plain; charset=UTF-8",Be=(e,r)=>({"Content-Type":e,...r}),Te,Ie,q,he,W,C,De,Ee,_e,se,Se,je,K,pe,Qe,Wr=(Qe=class{constructor(e,r){w(this,K);w(this,Te);w(this,Ie);y(this,"env",{});w(this,q);y(this,"finalized",!1);y(this,"error");w(this,he);w(this,W);w(this,C);w(this,De);w(this,Ee);w(this,_e);w(this,se);w(this,Se);w(this,je);y(this,"render",(...e)=>(l(this,Ee)??g(this,Ee,r=>this.html(r)),l(this,Ee).call(this,...e)));y(this,"setLayout",e=>g(this,De,e));y(this,"getLayout",()=>l(this,De));y(this,"setRenderer",e=>{g(this,Ee,e)});y(this,"header",(e,r,t)=>{this.finalized&&g(this,C,new Response(l(this,C).body,l(this,C)));const s=l(this,C)?l(this,C).headers:l(this,se)??g(this,se,new Headers);r===void 0?s.delete(e):t!=null&&t.append?s.append(e,r):s.set(e,r)});y(this,"status",e=>{g(this,he,e)});y(this,"set",(e,r)=>{l(this,q)??g(this,q,new Map),l(this,q).set(e,r)});y(this,"get",e=>l(this,q)?l(this,q).get(e):void 0);y(this,"newResponse",(...e)=>b(this,K,pe).call(this,...e));y(this,"body",(e,r,t)=>b(this,K,pe).call(this,e,r,t));y(this,"text",(e,r,t)=>!l(this,se)&&!l(this,he)&&!r&&!t&&!this.finalized?new Response(e):b(this,K,pe).call(this,e,r,Be(qr,t)));y(this,"json",(e,r,t)=>b(this,K,pe).call(this,JSON.stringify(e),r,Be("application/json",t)));y(this,"html",(e,r,t)=>{const s=n=>b(this,K,pe).call(this,n,r,Be("text/html; charset=UTF-8",t));return typeof e=="object"?lr(e,Hr.Stringify,!1,{}).then(s):s(e)});y(this,"redirect",(e,r)=>{const t=String(e);return this.header("Location",/[^\x00-\xFF]/.test(t)?encodeURI(t):t),this.newResponse(null,r??302)});y(this,"notFound",()=>(l(this,_e)??g(this,_e,()=>new Response),l(this,_e).call(this,this)));g(this,Te,e),r&&(g(this,W,r.executionCtx),this.env=r.env,g(this,_e,r.notFoundHandler),g(this,je,r.path),g(this,Se,r.matchResult))}get req(){return l(this,Ie)??g(this,Ie,new dr(l(this,Te),l(this,je),l(this,Se))),l(this,Ie)}get event(){if(l(this,W)&&"respondWith"in l(this,W))return l(this,W);throw Error("This context has no FetchEvent")}get executionCtx(){if(l(this,W))return l(this,W);throw Error("This context has no ExecutionContext")}get res(){return l(this,C)||g(this,C,new Response(null,{headers:l(this,se)??g(this,se,new Headers)}))}set res(e){if(l(this,C)&&e){e=new Response(e.body,e);for(const[r,t]of l(this,C).headers.entries())if(r!=="content-type")if(r==="set-cookie"){const s=l(this,C).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of s)e.headers.append("set-cookie",n)}else e.headers.set(r,t)}g(this,C,e),this.finalized=!0}get var(){return l(this,q)?Object.fromEntries(l(this,q)):{}}},Te=new WeakMap,Ie=new WeakMap,q=new WeakMap,he=new WeakMap,W=new WeakMap,C=new WeakMap,De=new WeakMap,Ee=new WeakMap,_e=new WeakMap,se=new WeakMap,Se=new WeakMap,je=new WeakMap,K=new WeakSet,pe=function(e,r,t){const s=l(this,C)?new Headers(l(this,C).headers):l(this,se)??new Headers;if(typeof r=="object"&&"headers"in r){const a=r.headers instanceof Headers?r.headers:new Headers(r.headers);for(const[o,i]of a)o.toLowerCase()==="set-cookie"?s.append(o,i):s.set(o,i)}if(t)for(const[a,o]of Object.entries(t))if(typeof o=="string")s.set(a,o);else{s.delete(a);for(const i of o)s.append(a,i)}const n=typeof r=="number"?r:(r==null?void 0:r.status)??l(this,he);return new Response(e,{status:n,headers:s})},Qe),S="ALL",$r="all",Vr=["get","post","put","delete","options","patch"],pr="Can not add a route since the matcher is already built.",mr=class extends Error{},Gr="__COMPOSED_HANDLER",Yr=e=>e.text("404 Not Found",404),Ke=(e,r)=>{if("getResponse"in e){const t=e.getResponse();return r.newResponse(t.body,t)}return console.error(e),r.text("Internal Server Error",500)},M,j,fr,F,re,ke,Ce,ge,Kr=(ge=class{constructor(r={}){w(this,j);y(this,"get");y(this,"post");y(this,"put");y(this,"delete");y(this,"options");y(this,"patch");y(this,"all");y(this,"on");y(this,"use");y(this,"router");y(this,"getPath");y(this,"_basePath","/");w(this,M,"/");y(this,"routes",[]);w(this,F,Yr);y(this,"errorHandler",Ke);y(this,"onError",r=>(this.errorHandler=r,this));y(this,"notFound",r=>(g(this,F,r),this));y(this,"fetch",(r,...t)=>b(this,j,Ce).call(this,r,t[1],t[0],r.method));y(this,"request",(r,t,s,n)=>r instanceof Request?this.fetch(t?new Request(r,t):r,s,n):(r=r.toString(),this.fetch(new Request(/^https?:\/\//.test(r)?r:`http://localhost${le("/",r)}`,t),s,n)));y(this,"fire",()=>{addEventListener("fetch",r=>{r.respondWith(b(this,j,Ce).call(this,r.request,r,void 0,r.request.method))})});[...Vr,$r].forEach(a=>{this[a]=(o,...i)=>(typeof o=="string"?g(this,M,o):b(this,j,re).call(this,a,l(this,M),o),i.forEach(u=>{b(this,j,re).call(this,a,l(this,M),u)}),this)}),this.on=(a,o,...i)=>{for(const u of[o].flat()){g(this,M,u);for(const d of[a].flat())i.map(c=>{b(this,j,re).call(this,d.toUpperCase(),l(this,M),c)})}return this},this.use=(a,...o)=>(typeof a=="string"?g(this,M,a):(g(this,M,"*"),o.unshift(a)),o.forEach(i=>{b(this,j,re).call(this,S,l(this,M),i)}),this);const{strict:s,...n}=r;Object.assign(this,n),this.getPath=s??!0?r.getPath??nr:Mr}route(r,t){const s=this.basePath(r);return t.routes.map(n=>{var o;let a;t.errorHandler===Ke?a=n.handler:(a=async(i,u)=>(await Ge([],t.errorHandler)(i,()=>n.handler(i,u))).res,a[Gr]=n.handler),b(o=s,j,re).call(o,n.method,n.path,a)}),this}basePath(r){const t=b(this,j,fr).call(this);return t._basePath=le(this._basePath,r),t}mount(r,t,s){let n,a;s&&(typeof s=="function"?a=s:(a=s.optionHandler,s.replaceRequest===!1?n=u=>u:n=s.replaceRequest));const o=a?u=>{const d=a(u);return Array.isArray(d)?d:[d]}:u=>{let d;try{d=u.executionCtx}catch{}return[u.env,d]};n||(n=(()=>{const u=le(this._basePath,r),d=u==="/"?0:u.length;return c=>{const m=new URL(c.url);return m.pathname=m.pathname.slice(d)||"/",new Request(m,c)}})());const i=async(u,d)=>{const c=await t(n(u.req.raw),...o(u));if(c)return c;await d()};return b(this,j,re).call(this,S,le(r,"*"),i),this}},M=new WeakMap,j=new WeakSet,fr=function(){const r=new ge({router:this.router,getPath:this.getPath});return r.errorHandler=this.errorHandler,g(r,F,l(this,F)),r.routes=this.routes,r},F=new WeakMap,re=function(r,t,s){r=r.toUpperCase(),t=le(this._basePath,t);const n={basePath:this._basePath,path:t,method:r,handler:s};this.router.add(r,t,[s,n]),this.routes.push(n)},ke=function(r,t){if(r instanceof Error)return this.errorHandler(r,t);throw r},Ce=function(r,t,s,n){if(n==="HEAD")return(async()=>new Response(null,await b(this,j,Ce).call(this,r,t,s,"GET")))();const a=this.getPath(r,{env:s}),o=this.router.match(n,a),i=new Wr(r,{path:a,matchResult:o,env:s,executionCtx:t,notFoundHandler:l(this,F)});if(o[0].length===1){let d;try{d=o[0][0][0][0](i,async()=>{i.res=await l(this,F).call(this,i)})}catch(c){return b(this,j,ke).call(this,c,i)}return d instanceof Promise?d.then(c=>c||(i.finalized?i.res:l(this,F).call(this,i))).catch(c=>b(this,j,ke).call(this,c,i)):d??l(this,F).call(this,i)}const u=Ge(o[0],this.errorHandler,l(this,F));return(async()=>{try{const d=await u(i);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return b(this,j,ke).call(this,d,i)}})()},ge),hr=[];function Jr(e,r){const t=this.buildAllMatchers(),s=((n,a)=>{const o=t[n]||t[S],i=o[2][a];if(i)return i;const u=a.match(o[0]);if(!u)return[[],hr];const d=u.indexOf("",1);return[o[1][d],u]});return this.match=s,s(e,r)}var Ue="[^/]+",be=".*",Re="(?:|/.*)",me=Symbol(),zr=new Set(".\\+*[^]$()");function Xr(e,r){return e.length===1?r.length===1?e<r?-1:1:-1:r.length===1||e===be||e===Re?1:r===be||r===Re?-1:e===Ue?1:r===Ue?-1:e.length===r.length?e<r?-1:1:r.length-e.length}var ne,ae,B,de,Qr=(de=class{constructor(){w(this,ne);w(this,ae);w(this,B,Object.create(null))}insert(r,t,s,n,a){if(r.length===0){if(l(this,ne)!==void 0)throw me;if(a)return;g(this,ne,t);return}const[o,...i]=r,u=o==="*"?i.length===0?["","",be]:["","",Ue]:o==="/*"?["","",Re]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(u){const c=u[1];let m=u[2]||Ue;if(c&&u[2]&&(m===".*"||(m=m.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(m))))throw me;if(d=l(this,B)[m],!d){if(Object.keys(l(this,B)).some(f=>f!==be&&f!==Re))throw me;if(a)return;d=l(this,B)[m]=new de,c!==""&&g(d,ae,n.varIndex++)}!a&&c!==""&&s.push([c,l(d,ae)])}else if(d=l(this,B)[o],!d){if(Object.keys(l(this,B)).some(c=>c.length>1&&c!==be&&c!==Re))throw me;if(a)return;d=l(this,B)[o]=new de}d.insert(i,t,s,n,a)}buildRegExpStr(){const t=Object.keys(l(this,B)).sort(Xr).map(s=>{const n=l(this,B)[s];return(typeof l(n,ae)=="number"?`(${s})@${l(n,ae)}`:zr.has(s)?`\\${s}`:s)+n.buildRegExpStr()});return typeof l(this,ne)=="number"&&t.unshift(`#${l(this,ne)}`),t.length===0?"":t.length===1?t[0]:"(?:"+t.join("|")+")"}},ne=new WeakMap,ae=new WeakMap,B=new WeakMap,de),Le,Ae,Ze,Zr=(Ze=class{constructor(){w(this,Le,{varIndex:0});w(this,Ae,new Qr)}insert(e,r,t){const s=[],n=[];for(let o=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,u=>{const d=`@\\${o}`;return n[o]=[d,u],o++,i=!0,d}),!i)break}const a=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=n.length-1;o>=0;o--){const[i]=n[o];for(let u=a.length-1;u>=0;u--)if(a[u].indexOf(i)!==-1){a[u]=a[u].replace(i,n[o][1]);break}}return l(this,Ae).insert(a,r,s,l(this,Le),t),s}buildRegExp(){let e=l(this,Ae).buildRegExpStr();if(e==="")return[/^$/,[],[]];let r=0;const t=[],s=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,a,o)=>a!==void 0?(t[++r]=Number(a),"$()"):(o!==void 0&&(s[Number(o)]=++r),"")),[new RegExp(`^${e}`),t,s]}},Le=new WeakMap,Ae=new WeakMap,Ze),et=[/^$/,[],Object.create(null)],Ne=Object.create(null);function Er(e){return Ne[e]??(Ne[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(r,t)=>t?`\\${t}`:"(?:|/.*)")}$`))}function rt(){Ne=Object.create(null)}function tt(e){var d;const r=new Zr,t=[];if(e.length===0)return et;const s=e.map(c=>[!/\*|\/:/.test(c[0]),...c]).sort(([c,m],[f,E])=>c?1:f?-1:m.length-E.length),n=Object.create(null);for(let c=0,m=-1,f=s.length;c<f;c++){const[E,h,v]=s[c];E?n[h]=[v.map(([T])=>[T,Object.create(null)]),hr]:m++;let _;try{_=r.insert(h,m,E)}catch(T){throw T===me?new mr(h):T}E||(t[m]=v.map(([T,R])=>{const I=Object.create(null);for(R-=1;R>=0;R--){const[U,D]=_[R];I[U]=D}return[T,I]}))}const[a,o,i]=r.buildRegExp();for(let c=0,m=t.length;c<m;c++)for(let f=0,E=t[c].length;f<E;f++){const h=(d=t[c][f])==null?void 0:d[1];if(!h)continue;const v=Object.keys(h);for(let _=0,T=v.length;_<T;_++)h[v[_]]=i[h[v[_]]]}const u=[];for(const c in o)u[c]=t[o[c]];return[a,u,n]}function ce(e,r){if(e){for(const t of Object.keys(e).sort((s,n)=>n.length-s.length))if(Er(t).test(r))return[...e[t]]}}var J,z,xe,_r,er,st=(er=class{constructor(){w(this,xe);y(this,"name","RegExpRouter");w(this,J);w(this,z);y(this,"match",Jr);g(this,J,{[S]:Object.create(null)}),g(this,z,{[S]:Object.create(null)})}add(e,r,t){var i;const s=l(this,J),n=l(this,z);if(!s||!n)throw new Error(pr);s[e]||[s,n].forEach(u=>{u[e]=Object.create(null),Object.keys(u[S]).forEach(d=>{u[e][d]=[...u[S][d]]})}),r==="/*"&&(r="*");const a=(r.match(/\/:/g)||[]).length;if(/\*$/.test(r)){const u=Er(r);e===S?Object.keys(s).forEach(d=>{var c;(c=s[d])[r]||(c[r]=ce(s[d],r)||ce(s[S],r)||[])}):(i=s[e])[r]||(i[r]=ce(s[e],r)||ce(s[S],r)||[]),Object.keys(s).forEach(d=>{(e===S||e===d)&&Object.keys(s[d]).forEach(c=>{u.test(c)&&s[d][c].push([t,a])})}),Object.keys(n).forEach(d=>{(e===S||e===d)&&Object.keys(n[d]).forEach(c=>u.test(c)&&n[d][c].push([t,a]))});return}const o=ar(r)||[r];for(let u=0,d=o.length;u<d;u++){const c=o[u];Object.keys(n).forEach(m=>{var f;(e===S||e===m)&&((f=n[m])[c]||(f[c]=[...ce(s[m],c)||ce(s[S],c)||[]]),n[m][c].push([t,a-d+u+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(l(this,z)).concat(Object.keys(l(this,J))).forEach(r=>{e[r]||(e[r]=b(this,xe,_r).call(this,r))}),g(this,J,g(this,z,void 0)),rt(),e}},J=new WeakMap,z=new WeakMap,xe=new WeakSet,_r=function(e){const r=[];let t=e===S;return[l(this,J),l(this,z)].forEach(s=>{const n=s[e]?Object.keys(s[e]).map(a=>[a,s[e][a]]):[];n.length!==0?(t||(t=!0),r.push(...n)):e!==S&&r.push(...Object.keys(s[S]).map(a=>[a,s[S][a]]))}),t?tt(r):null},er),X,$,rr,nt=(rr=class{constructor(e){y(this,"name","SmartRouter");w(this,X,[]);w(this,$,[]);g(this,X,e.routers)}add(e,r,t){if(!l(this,$))throw new Error(pr);l(this,$).push([e,r,t])}match(e,r){if(!l(this,$))throw new Error("Fatal error");const t=l(this,X),s=l(this,$),n=t.length;let a=0,o;for(;a<n;a++){const i=t[a];try{for(let u=0,d=s.length;u<d;u++)i.add(...s[u]);o=i.match(e,r)}catch(u){if(u instanceof mr)continue;throw u}this.match=i.match.bind(i),g(this,X,[i]),g(this,$,void 0);break}if(a===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(l(this,$)||l(this,X).length!==1)throw new Error("No active router has been determined yet.");return l(this,X)[0]}},X=new WeakMap,$=new WeakMap,rr),ve=Object.create(null),Q,k,oe,ye,A,V,te,we,at=(we=class{constructor(r,t,s){w(this,V);w(this,Q);w(this,k);w(this,oe);w(this,ye,0);w(this,A,ve);if(g(this,k,s||Object.create(null)),g(this,Q,[]),r&&t){const n=Object.create(null);n[r]={handler:t,possibleKeys:[],score:0},g(this,Q,[n])}g(this,oe,[])}insert(r,t,s){g(this,ye,++Ve(this,ye)._);let n=this;const a=Nr(t),o=[];for(let i=0,u=a.length;i<u;i++){const d=a[i],c=a[i+1],m=xr(d,c),f=Array.isArray(m)?m[0]:d;if(f in l(n,k)){n=l(n,k)[f],m&&o.push(m[1]);continue}l(n,k)[f]=new we,m&&(l(n,oe).push(m),o.push(m[1])),n=l(n,k)[f]}return l(n,Q).push({[r]:{handler:s,possibleKeys:o.filter((i,u,d)=>d.indexOf(i)===u),score:l(this,ye)}}),n}search(r,t){var u;const s=[];g(this,A,ve);let a=[this];const o=sr(t),i=[];for(let d=0,c=o.length;d<c;d++){const m=o[d],f=d===c-1,E=[];for(let h=0,v=a.length;h<v;h++){const _=a[h],T=l(_,k)[m];T&&(g(T,A,l(_,A)),f?(l(T,k)["*"]&&s.push(...b(this,V,te).call(this,l(T,k)["*"],r,l(_,A))),s.push(...b(this,V,te).call(this,T,r,l(_,A)))):E.push(T));for(let R=0,I=l(_,oe).length;R<I;R++){const U=l(_,oe)[R],D=l(_,A)===ve?{}:{...l(_,A)};if(U==="*"){const O=l(_,k)["*"];O&&(s.push(...b(this,V,te).call(this,O,r,l(_,A))),g(O,A,D),E.push(O));continue}const[Z,ee,L]=U;if(!m&&!(L instanceof RegExp))continue;const N=l(_,k)[Z],x=o.slice(d).join("/");if(L instanceof RegExp){const O=L.exec(x);if(O){if(D[ee]=O[0],s.push(...b(this,V,te).call(this,N,r,l(_,A),D)),Object.keys(l(N,k)).length){g(N,A,D);const H=((u=O[0].match(/\//))==null?void 0:u.length)??0;(i[H]||(i[H]=[])).push(N)}continue}}(L===!0||L.test(m))&&(D[ee]=m,f?(s.push(...b(this,V,te).call(this,N,r,D,l(_,A))),l(N,k)["*"]&&s.push(...b(this,V,te).call(this,l(N,k)["*"],r,D,l(_,A)))):(g(N,A,D),E.push(N)))}}a=E.concat(i.shift()??[])}return s.length>1&&s.sort((d,c)=>d.score-c.score),[s.map(({handler:d,params:c})=>[d,c])]}},Q=new WeakMap,k=new WeakMap,oe=new WeakMap,ye=new WeakMap,A=new WeakMap,V=new WeakSet,te=function(r,t,s,n){const a=[];for(let o=0,i=l(r,Q).length;o<i;o++){const u=l(r,Q)[o],d=u[t]||u[S],c={};if(d!==void 0&&(d.params=Object.create(null),a.push(d),s!==ve||n&&n!==ve))for(let m=0,f=d.possibleKeys.length;m<f;m++){const E=d.possibleKeys[m],h=c[d.score];d.params[E]=n!=null&&n[E]&&!h?n[E]:s[E]??(n==null?void 0:n[E]),c[d.score]=!0}}return a},we),ie,tr,ot=(tr=class{constructor(){y(this,"name","TrieRouter");w(this,ie);g(this,ie,new at)}add(e,r,t){const s=ar(r);if(s){for(let n=0,a=s.length;n<a;n++)l(this,ie).insert(e,s[n],t);return}l(this,ie).insert(e,r,t)}match(e,r){return l(this,ie).search(e,r)}},ie=new WeakMap,tr),gr=class extends Kr{constructor(e={}){super(e),this.router=e.router??new nt({routers:[new st,new ot]})}},it=e=>{const t={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},s=(a=>typeof a=="string"?a==="*"?()=>a:o=>a===o?o:null:typeof a=="function"?a:o=>a.includes(o)?o:null)(t.origin),n=(a=>typeof a=="function"?a:Array.isArray(a)?()=>a:()=>[])(t.allowMethods);return async function(o,i){var c;function u(m,f){o.res.headers.set(m,f)}const d=await s(o.req.header("origin")||"",o);if(d&&u("Access-Control-Allow-Origin",d),t.credentials&&u("Access-Control-Allow-Credentials","true"),(c=t.exposeHeaders)!=null&&c.length&&u("Access-Control-Expose-Headers",t.exposeHeaders.join(",")),o.req.method==="OPTIONS"){t.origin!=="*"&&u("Vary","Origin"),t.maxAge!=null&&u("Access-Control-Max-Age",t.maxAge.toString());const m=await n(o.req.header("origin")||"",o);m.length&&u("Access-Control-Allow-Methods",m.join(","));let f=t.allowHeaders;if(!(f!=null&&f.length)){const E=o.req.header("Access-Control-Request-Headers");E&&(f=E.split(/\s*,\s*/))}return f!=null&&f.length&&(u("Access-Control-Allow-Headers",f.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await i(),t.origin!=="*"&&o.header("Vary","Origin",{append:!0})}},dt=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,Je=(e,r=ct)=>{const t=/\.([a-zA-Z0-9]+?)$/,s=e.match(t);if(!s)return;let n=r[s[1]];return n&&n.startsWith("text")&&(n+="; charset=utf-8"),n},ut={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},ct=ut,lt=(...e)=>{let r=e.filter(n=>n!=="").join("/");r=r.replace(new RegExp("(?<=\\/)\\/+","g"),"");const t=r.split("/"),s=[];for(const n of t)n===".."&&s.length>0&&s.at(-1)!==".."?s.pop():n!=="."&&s.push(n);return s.join("/")||"."},yr={br:".br",zstd:".zst",gzip:".gz"},pt=Object.keys(yr),mt="index.html",ft=e=>{const r=e.root??"./",t=e.path,s=e.join??lt;return async(n,a)=>{var c,m,f,E;if(n.finalized)return a();let o;if(e.path)o=e.path;else try{if(o=decodeURIComponent(n.req.path),/(?:^|[\/\\])\.\.(?:$|[\/\\])/.test(o))throw new Error}catch{return await((c=e.onNotFound)==null?void 0:c.call(e,n.req.path,n)),a()}let i=s(r,!t&&e.rewriteRequestPath?e.rewriteRequestPath(o):o);e.isDir&&await e.isDir(i)&&(i=s(i,mt));const u=e.getContent;let d=await u(i,n);if(d instanceof Response)return n.newResponse(d.body,d);if(d){const h=e.mimes&&Je(i,e.mimes)||Je(i);if(n.header("Content-Type",h||"application/octet-stream"),e.precompressed&&(!h||dt.test(h))){const v=new Set((m=n.req.header("Accept-Encoding"))==null?void 0:m.split(",").map(_=>_.trim()));for(const _ of pt){if(!v.has(_))continue;const T=await u(i+yr[_],n);if(T){d=T,n.header("Content-Encoding",_),n.header("Vary","Accept-Encoding",{append:!0});break}}}return await((f=e.onFound)==null?void 0:f.call(e,i,n)),n.body(d)}await((E=e.onNotFound)==null?void 0:E.call(e,i,n)),await a()}},ht=async(e,r)=>{let t;r&&r.manifest?typeof r.manifest=="string"?t=JSON.parse(r.manifest):t=r.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?t=JSON.parse(__STATIC_CONTENT_MANIFEST):t=__STATIC_CONTENT_MANIFEST;let s;r&&r.namespace?s=r.namespace:s=__STATIC_CONTENT;const n=t[e]||e;if(!n)return null;const a=await s.get(n,{type:"stream"});return a||null},Et=e=>async function(t,s){return ft({...e,getContent:async a=>ht(a,{manifest:e.manifest,namespace:e.namespace?e.namespace:t.env?t.env.__STATIC_CONTENT:void 0})})(t,s)},_t=e=>Et(e);async function gt(e,r,t,s,n){const a={typ:"JWT",alg:"HS256",cty:"twilio-fpa;v=1"},o=Math.floor(Date.now()/1e3),i=o+3600,u={room:n},d={jti:`${r}-${o}`,iss:r,sub:e,exp:i,grants:{identity:s,video:u}},c=U=>{const D=JSON.stringify(U);return btoa(D).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")},m=c(a),f=c(d),E=`${m}.${f}`,h=new TextEncoder,v=h.encode(t),_=await crypto.subtle.importKey("raw",v,{name:"HMAC",hash:"SHA-256"},!1,["sign"]),T=await crypto.subtle.sign("HMAC",_,h.encode(E)),R=new Uint8Array(T);let I=btoa(String.fromCharCode(...R));return I=I.replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,""),`${E}.${I}`}const p=new gr;p.use("/api/*",it());p.use("/static/*",_t({root:"./public"}));async function wr(e,r,t,s,n){try{const a=`${t}/verify-email?token=${r}`,o=await fetch("https://api.resend.com/emails",{method:"POST",headers:{Authorization:`Bearer ${s}`,"Content-Type":"application/json"},body:JSON.stringify({from:`Amebo <${n}>`,to:e,subject:"Verify your Amebo account",html:`
    ...
    `).bind(r).first();if(!t)return e.json({success:!0,message:"If an account with that email exists, a password reset link has been sent."});const s=new Date(Date.now()-3600*1e3).toISOString();if(t.last_password_reset&&t.last_password_reset>s&&t.password_reset_attempts>=5)return e.json({error:"Too many password reset attempts. Please try again in 1 hour."},429);const n=crypto.randomUUID(),a=new Date(Date.now()+3600*1e3);await e.env.DB.prepare(`
      ...
      SET password_reset_token = ?,
          ...
          last_password_reset = ?
      WHERE id = ?
    `).bind(n,a.toISOString(),new Date().toISOString(),t.id).run();const o=e.env.APP_URL||"http://localhost:3000",i=e.env.RESEND_API_KEY||"",u=e.env.FROM_EMAIL||"onboarding@resend.dev";if(i)try{const d=`${o}/reset-password?token=${n}`,c=await fetch("https://api.resend.com/emails",{method:"POST",headers:{Authorization:`Bearer ${i}`,"Content-Type":"application/json"},body:JSON.stringify({from:`Amebo <${u}>`,to:r,subject:"Reset your Amebo password",html:`
              <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
    ...
    `).bind(t,r).run(),e.json({success:!0,message:"Username updated"}))}catch(r){return console.error("Username update error:",r),e.json({error:"Failed to update username"},500)}});p.post("/api/users/update-profile",async e=>{try{const{userId:r,displayName:t,bio:s}=await e.req.json();return r?(await e.env.DB.prepare(`
      UPDATE users SET display_name = ?, bio = ? WHERE id = ?
    `).bind(t||null,s||null,r).run(),e.json({success:!0,message:"Profile updated",displayName:t,bio:s})):e.json({error:"User ID required"},400)}catch(r){return console.error("Profile update error:",r),e.json({error:"Failed to update profile"},500)}});p.post("/api/users/update-password",async e=>{try{const{userId:r,email:t,currentPassword:s,newPassword:n}=await e.req.json();if(!r||!s||!n)return e.json({error:"All fields required"},400);const a=await e.env.DB.prepare(`
    ...
    `).bind(s,n,n,s).first();if(o){const R=await e.env.DB.prepare(`
        SELECT 
          r.*,
        ...
        WHERE r.id = ?
      `).bind(n,o.room_id).first(),I={...R,other_user:R.other_user_id?{id:R.other_user_id,username:R.other_user_username,display_name:R.other_user_display_name,email:R.other_user_email,avatar:R.other_user_avatar,online_status:R.other_user_online_status,last_seen:R.other_user_last_seen}:null};return e.json({success:!0,room:I,isNew:!1})}const i=crypto.randomUUID(),u=crypto.randomUUID(),d=await e.env.DB.prepare(`
      SELECT username, display_name FROM users WHERE id = ?
    `).bind(n).first(),c=(d==null?void 0:d.display_name)||(d==null?void 0:d.username)||"Direct Message",m=`dm-${crypto.randomUUID().slice(0,8)}`,f=await e.env.DB.prepare(`
    ...
    `).bind(i,m,c,s).run();console.log("[DM CREATE] ✅ Room created:",i),await e.env.DB.prepare(`
      ...
      VALUES (?, ?, ?, ?)
    `).bind(u,s,n,i).run(),console.log("[DM CREATE] ✅ DM mapping created");const E=await e.env.DB.prepare(`
      INSERT OR IGNORE INTO room_members (room_id, user_id) VALUES (?, ?)
    `).bind(i,s).run(),h=await e.env.DB.prepare(`
      INSERT OR IGNORE INTO room_members (room_id, user_id) VALUES (?, ?)
    `).bind(i,n).run();console.log("[DM CREATE] ✅ Members added:",{user1:s,user2:n});const v=await e.env.DB.prepare(`
      SELECT * FROM room_members WHERE room_id = ?
    `).bind(i).all();console.log("[DM CREATE] 👥 Verified members:",v.results.length);const _=await e.env.DB.prepare(`
      SELECT 
        r.*,
        u2.id as other_user_id,
        u2.username as other_user_username,
      ...
      LEFT JOIN users u2 ON u2.id = ?
      WHERE r.id = ?
    `).bind(n,i).first(),T={..._,other_user:_.other_user_id?{id:_.other_user_id,username:_.other_user_username,display_name:_.other_user_display_name,email:_.other_user_email,avatar:_.other_user_avatar,online_status:_.other_user_online_status,last_seen:_.other_user_last_seen}:null};return e.json({success:!0,room:T,isNew:!0,message:"Direct message room created"})}catch(r){return console.error("DM creation error:",r),e.json({error:"Failed to create direct message",details:r.message},500)}});p.get("/api/rooms/shared/:userId/:otherUserId",async e=>{var r;try{const t=e.req.param("userId"),s=e.req.param("otherUserId"),n=await e.env.DB.prepare(`
    ...
    `).bind(t).first();return n&&n.count===0&&(await e.env.DB.prepare(`
      ...
      `).bind(t).run(),console.log(`[ROOM] Deleted empty room: ${t}`)),e.json({success:!0,message:"Left room successfully"})}catch(r){return console.error("[ROOM] Leave error:",r),e.json({error:"Failed to leave room",details:r.message},500)}});p.post("/api/messages/send",async e=>{try{const{roomId:r,senderId:t,encryptedContent:s,iv:n}=await e.req.json();if(!r||!t||!s||!n)return e.json({error:"All fields required"},400);let a=await e.env.DB.prepare(`
      SELECT * FROM room_members WHERE room_id = ? AND user_id = ?
    `).bind(r,t).first();if(!a)if(console.log("[SEND] ⚠️ User not in room_members, checking if DM room..."),await e.env.DB.prepare(`
        SELECT * FROM direct_message_rooms 
        WHERE room_id = ? AND (user1_id = ? OR user2_id = ?)
      `).bind(r,t,t).first()){if(console.log("[SEND] ✅ DM room found, auto-adding user as member"),await e.env.DB.prepare(`
          INSERT OR IGNORE INTO room_members (room_id, user_id) VALUES (?, ?)
        `).bind(r,t).run(),a=await e.env.DB.prepare(`
          SELECT * FROM room_members WHERE room_id = ? AND user_id = ?
        `).bind(r,t).first(),!a)return console.error("[SEND] ❌ Failed to auto-add member"),e.json({error:"Failed to add room member"},500)}else return console.error("[SEND] ❌ Not a member and not a DM participant"),e.json({error:"Not a member of this room"},403);const o=crypto.randomUUID();return await e.env.DB.prepare(`
      INSERT INTO messages (id, room_id, sender_id, encrypted_content, iv) 
      VALUES (?, ?, ?, ?, ?)
    `).bind(o,r,t,s,n).run(),e.json({success:!0,messageId:o,message:"Message sent successfully"})}catch{return e.json({error:"Failed to send message"},500)}});p.get("/api/messages/:roomId",async e=>{try{const r=e.req.param("roomId"),t=parseInt(e.req.query("limit")||"50"),s=parseInt(e.req.query("offset")||"0"),n=await e.env.DB.prepare(`
      ...
      LIMIT ? OFFSET ?
    `).bind(r,t,s).all(),a=e.json({success:!0,messages:(n.results||[]).reverse()});return a.headers.set("Cache-Control","no-store, no-cache, must-revalidate, max-age=0"),a.headers.set("Pragma","no-cache"),a.headers.set("Expires","0"),a}catch{return e.json({error:"Failed to fetch messages"},500)}});p.post("/api/twilio/token",async e=>{try{const{roomCode:r,userName:t}=await e.req.json();if(!r||!t)return e.json({error:"Room code and user name required"},400);const s=e.env.TWILIO_ACCOUNT_SID,n=e.env.TWILIO_API_KEY,a=e.env.TWILIO_API_SECRET;if(!s||!n||!a)return e.json({error:"Twilio credentials not configured",message:"Please configure TWILIO_ACCOUNT_SID, TWILIO_API_KEY, and TWILIO_API_SECRET in environment variables. See TWILIO_SETUP_GUIDE.md for details."},503);const o=t,i=r,u=await gt(s,n,a,o,i);return e.json({success:!0,token:u,identity:o,roomName:i,message:"Access token generated successfully"})}catch(r){return console.error("Twilio token generation error:",r),e.json({error:"Failed to generate access token",details:r.message},500)}});p.post("/api/notifications/subscribe",async e=>{try{const{userId:r,subscription:t}=await e.req.json();return!r||!t?e.json({error:"User ID and subscription required"},400):(await e.env.DB.prepare(`
  ...
  `).first(),i=(o==null?void 0:o.cap_value)||1400;let u=await e.prepare(`
    SELECT * FROM monthly_earning_caps WHERE user_id = ? AND year_month = ?
  `).bind(r,s).first();u||(await e.prepare(`
      ...
      VALUES (?, ?, 0, 0, 0, 0, 0)
    `).bind(r,s).run(),u={total_earned:0});const d=u.total_earned||0,c=a-d;if(d+t>a)return await e.prepare(`
    ...
    SELECT cap_value FROM monthly_cap_config WHERE cap_name = 'monthly_total_cap' AND is_active = 1
  `).first(),i=(o==null?void 0:o.cap_value)||1500,u=await e.prepare(`
    SELECT total_earned FROM monthly_earning_caps WHERE user_id = ? AND year_month = ?
  `).bind(r,n).first(),d=(u==null?void 0:u.total_earned)||0;await e.prepare(`
    INSERT INTO monthly_cap_history (user_id, year_month, action, tokens_earned, tokens_total, cap_limit, exceeded)
    VALUES (?, ?, ?, ?, ?, ?, 0)
  ...
  `).bind(r,n).first();a||(await e.prepare(`
      ...
      VALUES (?, ?, 0, 0, 0)
    `).bind(r,n).run(),a={messages_count:0,files_count:0,total_earned:0});const o=100,i=60,u=500;return t==="message_sent"&&a.messages_count+s>o?{allowed:!1,reason:"Daily message token limit reached",current:a.messages_count,limit:o}:t==="file_shared"&&a.files_count+s>i?{allowed:!1,reason:"Daily file sharing token limit reached",current:a.files_count,limit:i}:a.total_earned+s>u?{allowed:!1,reason:"Daily total token limit reached",current:a.total_earned,limit:u}:{allowed:!0}}p.post("/api/tokens/award",async e=>{try{const{userId:r,amount:t,reason:s}=await e.req.json();if(!r||!t)return e.json({error:"User ID and amount required"},400);if(t<=0)return e.json({error:"Amount must be greater than 0"},400);const n=await e.env.DB.prepare(`
      SELECT tokens, token_tier, total_earned FROM users WHERE id = ?
    `).bind(r).first();if(!n)return console.log("[TOKEN] ⚠️ User not found:",r),e.json({error:"User not found"},404);const a=n.tokens||0,{tier:o,multiplier:i}=qe(a);try{const h=await vr(e.env.DB,r,t);if(!h.allowed)return console.log(`[TOKEN ECONOMY] ❌ Monthly limit reached for ${r}: ${h.reason}`),e.json({error:h.reason,monthlyLimitReached:!0,current:h.current,limit:h.limit,remaining:h.remaining},429)}catch(h){console.log("[TOKEN] ⚠️ Monthly limit check failed (table may not exist):",h.message)}const u=["message_sent","file_shared","message","file_share"];if(u.includes(s))try{const h=await yt(e.env.DB,r,s,t);if(!h.allowed)return console.log(`[TOKEN ECONOMY] ⚠️ Daily limit reached for ${r}: ${h.reason}`),e.json({error:h.reason,dailyLimitReached:!0,current:h.current,limit:h.limit},429)}catch(h){console.log("[TOKEN] ⚠️ Daily limit check failed (table may not exist):",h.message)}const d=Math.floor(t*i),c=a+d,m=qe(c).tier;await e.env.DB.prepare(`
      UPDATE users 
      SET tokens = tokens + ?, 
          token_tier = ?,
          total_earned = total_earned + ?
      WHERE id = ?
    `).bind(d,m,d,r).run();try{await e.env.DB.prepare(`
        INSERT INTO token_earnings (user_id, action, amount, tier, daily_total)
        VALUES (?, ?, ?, ?, ?)
      `).bind(r,s,d,o,d).run()}catch(h){console.log("[TOKEN] ⚠️ Failed to record token history (table may not exist):",h.message)}if(u.includes(s))try{const h=new Date().toISOString().split("T")[0],v=s==="message_sent"||s==="message"?"messages_count":"files_count";await e.env.DB.prepare(`
          UPDATE daily_earning_caps 
          SET ${v} = ${v} + ?,
              total_earned = total_earned + ?
          WHERE user_id = ? AND date = ?
        `).bind(d,d,r,h).run()}catch(h){console.log("[TOKEN] ⚠️ Failed to update daily caps (table may not exist):",h.message)}try{await br(e.env.DB,r,d,s)}catch(h){console.log("[TOKEN] ⚠️ Failed to update monthly tracking (table may not exist):",h.message)}const f=i>1?` (${o} tier ${i}x bonus!)`:"",E=monthlyCheck.isWarning?` ⚠️ Approaching monthly limit (${monthlyCheck.current+d}/${monthlyCheck.limit})`:"";return console.log(`[TOKEN ECONOMY] User ${r} earned ${d} tokens for ${s}${f}. New balance: ${c}${E}`),e.json({success:!0,newBalance:c,amount:d,baseAmount:t,multiplier:i,tier:m,tierBonus:i>1,reason:s,monthlyLimit:monthlyCheck.limit,monthlyEarned:monthlyCheck.current+d,monthlyRemaining:monthlyCheck.remaining,monthlyWarning:monthlyCheck.isWarning,monthlyPercentage:Math.floor((monthlyCheck.current+d)/monthlyCheck.limit*100)})}catch(r){return console.error("Award tokens error:",r),e.json({error:"Failed to award tokens"},500)}});p.get("/api/tokens/balance/:userId",async e=>{try{const r=e.req.param("userId"),t=await e.env.DB.prepare(`
    ...
    `).bind(`bonus_${t}`).first();if(!a)return e.json({error:"Invalid bonus type"},400);const o=a.cap_value,i=await vr(e.env.DB,r,o);if(!i.allowed)return e.json({error:`Cannot award bonus - monthly limit reached (${i.current}/${i.limit})`,monthlyLimitReached:!0,current:i.current,limit:i.limit},429);const u=await e.env.DB.prepare(`
      SELECT tokens FROM users WHERE id = ?
    `).bind(r).first();if(!u)return e.json({error:"User not found"},404);await e.env.DB.prepare(`
      UPDATE users 
      SET tokens = tokens + ?,
          total_earned = total_earned + ?
      WHERE id = ?
    `).bind(o,o,r).run(),await e.env.DB.prepare(`
      ...
      VALUES (?, ?, ?, ?)
    `).bind(r,s,t,o).run(),await br(e.env.DB,r,o,`bonus_${t}`);const d=(u.tokens||0)+o;return console.log(`[BONUS] User ${r} earned ${o} bonus tokens for ${t}. New balance: ${d}`),e.json({success:!0,bonusType:t,bonusAmount:o,newBalance:d,message:`🎉 +${o} bonus tokens!`,monthlyEarned:i.current+o,monthlyLimit:i.limit,monthlyRemaining:i.remaining})}catch(r){return console.error("Award bonus error:",r),e.json({error:"Failed to award bonus"},500)}});p.get("/api/tokens/bonus/:userId",async e=>{try{const r=e.req.param("userId"),t=new Date().toISOString().substring(0,7),s=await e.env.DB.prepare(`
    ...
    `).all(),i=s.results.map(E=>E.bonus_type),u=o.results.filter(E=>{const h=E.cap_name.replace("bonus_","");return!i.includes(h)}).map(E=>({type:E.cap_name.replace("bonus_",""),amount:E.cap_value,description:E.description})),d=await e.env.DB.prepare(`
      SELECT cap_value FROM monthly_cap_config WHERE cap_name = 'monthly_total_cap' AND is_active = 1
    `).first(),c=(d==null?void 0:d.cap_value)||1500,m=await e.env.DB.prepare(`
      SELECT total_earned FROM monthly_earning_caps WHERE user_id = ? AND year_month = ?
    `).bind(r,t).first(),f=(m==null?void 0:m.total_earned)||0;return e.json({success:!0,data:{monthlyLimit:c,monthlyEarned:f,monthlyRemaining:c-f,totalBonusTokensEarned:a,earned:s.results||[],available:u,note:"Bonuses award instant tokens that count toward the 1500 monthly limit"}})}catch(r){return console.error("Get bonuses error:",r),e.json({error:"Failed to get bonuses"},500)}});p.post("/api/users/pin/set",async e=>{try{const{userId:r,pin:t}=await e.req.json();if(!r||!t)return e.json({error:"User ID and PIN required"},400);if(t.length!==4||!/^\d{4}$/.test(t))return e.json({error:"PIN must be exactly 4 digits"},400);const s=await crypto.subtle.digest("SHA-256",new TextEncoder().encode(t)),n=Array.from(new Uint8Array(s)).map(a=>a.toString(16).padStart(2,"0")).join("");return await e.env.DB.prepare(`
    ...
    `).bind(r).first();if(!n||!n.security_answer)return e.json({error:"No security question set"},404);const a=new Date;if(n.last_pin_reset){const c=new Date(n.last_pin_reset),m=(a.getTime()-c.getTime())/(1e3*60*60);if(m<1&&n.pin_reset_attempts>=5)return e.json({error:"Too many reset attempts. Please try again in 1 hour.",remainingTime:Math.ceil((1-m)*60)},429);m>=1&&await e.env.DB.prepare(`
        ...
        SET pin_reset_attempts = pin_reset_attempts + 1,
            last_pin_reset = ?
        WHERE id = ?
      `).bind(a.toISOString(),r).run();const c=(n.pin_reset_attempts||0)+1,m=5-c;return console.log(`[PIN RESET] Failed attempt for user ${r}. Attempts: ${c}/5`),e.json({error:"Incorrect answer",verified:!1,remainingAttempts:Math.max(0,m)},400)}const u=await crypto.subtle.digest("SHA-256",new TextEncoder().encode(s)),d=Array.from(new Uint8Array(u)).map(c=>c.toString(16).padStart(2,"0")).join("");return await e.env.DB.prepare(`
      UPDATE users 
      SET pin = ?, 
          pin_reset_attempts = 0,
          last_pin_reset = ?
      WHERE id = ?
    `).bind(d,a.toISOString(),r).run(),console.log(`[PIN RESET] User ${r} successfully reset PIN`),e.json({success:!0,verified:!0,message:"PIN reset successfully"})}catch(r){return console.error("Reset PIN error:",r),e.json({error:"Failed to reset PIN"},500)}});p.post("/api/tokens/gift",async e=>{try{const{fromUserId:r,toUserId:t,amount:s,roomId:n,message:a,pin:o}=await e.req.json();if(!r||!t||!s||!o)return e.json({error:"From user, to user, amount, and PIN required"},400);if(s<=0)return e.json({error:"Amount must be greater than 0"},400);if(r===t)return e.json({error:"Cannot send tokens to yourself"},400);const i=new Date,u=new Date(i.getFullYear(),0,1),d=Math.floor((i.getTime()-u.getTime())/(1440*60*1e3)),c=Math.ceil((d+u.getDay()+1)/7),m=`${i.getFullYear()}-${String(c).padStart(2,"0")}`,f=await e.env.DB.prepare(`
      SELECT config_value FROM weekly_gift_config WHERE config_name = 'weekly_gift_limit' AND is_active = 1
    `).bind().first(),E=(f==null?void 0:f.config_value)||150;let h=await e.env.DB.prepare(`
      SELECT * FROM weekly_gift_tracking WHERE user_id = ? AND year_week = ?
    `).bind(r,m).first();h||(await e.env.DB.prepare(`
        INSERT INTO weekly_gift_tracking (user_id, year_week, total_gifted, gift_count)
        VALUES (?, ?, 0, 0)
      `).bind(r,m).run(),h={user_id:r,year_week:m,total_gifted:0,gift_count:0});const v=h.total_gifted||0,_=E-v;if(v+s>E)return console.log(`[WEEKLY GIFT LIMIT] User ${r} exceeded weekly limit. Current: ${v}, Attempting: ${s}, Limit: ${E}`),await e.env.DB.prepare(`
        INSERT INTO weekly_gift_history (user_id, year_week, amount, recipient_id, total_gifted_after, limit_value, exceeded)
        VALUES (?, ?, ?, ?, ?, ?, 1)
      `).bind(r,m,s,t,v,E).run(),e.json({error:`Weekly gift limit reached! You can only gift ${E} tokens per week. You have gifted ${v} tokens this week. Remaining: ${_} tokens`,weeklyLimit:E,weeklyGifted:v,weeklyRemaining:_,limitExceeded:!0},400);const T=await crypto.subtle.digest("SHA-256",new TextEncoder().encode(o)),R=Array.from(new Uint8Array(T)).map(Tr=>Tr.toString(16).padStart(2,"0")).join(""),I=await e.env.DB.prepare(`
      SELECT pin, tokens, username FROM users WHERE id = ?
    `).bind(r).first();if(!I)return e.json({error:"User not found"},404);if(!I.pin)return e.json({error:"Please set a PIN first"},400);if(I.pin!==R)return e.json({error:"Invalid PIN"},401);const U=I.tokens||0;if(U<s)return e.json({error:`Insufficient tokens. You have ${U} tokens`},400);const D=await e.env.DB.prepare(`
      SELECT username, tokens FROM users WHERE id = ?
    `).bind(t).first();if(!D)return e.json({error:"Recipient not found"},404);console.log(`[TOKEN GIFT] ${I.username} sending ${s} tokens to ${D.username} (Weekly: ${v+s}/${E})`);const Z=await e.env.DB.prepare(`
    ...
    `).bind(L,r,t,s,n||null,a||null).run(),console.log(`[TOKEN GIFT] Transaction recorded: ${L}`);const N=crypto.randomUUID();await e.env.DB.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?)
    `).bind(N,t,"token_gift","🎁 Token Gift Received!",`${I.username} sent you ${s} tokens${a?": "+a:""}`,JSON.stringify({fromUserId:r,amount:s,message:a,transactionId:L})).run(),console.log("[TOKEN GIFT] Notification created for receiver");const x=v+s;await e.env.DB.prepare(`
    ...
    `).bind(x,r,m).run(),console.log(`[WEEKLY GIFT TRACKING] Updated: ${x}/${E} tokens gifted this week`),await e.env.DB.prepare(`
      INSERT INTO weekly_gift_history (user_id, year_week, amount, recipient_id, total_gifted_after, limit_value, exceeded)
      VALUES (?, ?, ?, ?, ?, ?, 0)
    `).bind(r,m,s,t,x,E).run();const O=U-s,H=(D.tokens||0)+s,ue=E-x;let Pe="";return ue<=30&&ue>0?Pe=` ⚠️ Only ${ue} tokens remaining this week!`:ue===0&&(Pe=" 🚫 Weekly gift limit reached!"),e.json({success:!0,message:`Successfully sent ${s} tokens to ${D.username}${Pe}`,transactionId:L,newBalance:O,receiverUsername:D.username,receiverBalance:H,fromUsername:I.username,weeklyGifted:x,weeklyLimit:E,weeklyRemaining:ue})}catch(r){return console.error("Gift tokens error:",r),e.json({error:"Failed to gift tokens",details:r.message},500)}});p.get("/api/tokens/weekly-gift-status/:userId",async e=>{try{const r=e.req.param("userId"),t=new Date,s=new Date(t.getFullYear(),0,1),n=Math.floor((t.getTime()-s.getTime())/(1440*60*1e3)),a=Math.ceil((n+s.getDay()+1)/7),o=`${t.getFullYear()}-${String(a).padStart(2,"0")}`,i=await e.env.DB.prepare(`
      SELECT config_value FROM weekly_gift_config WHERE config_name = 'weekly_gift_limit' AND is_active = 1
    `).bind().first(),u=(i==null?void 0:i.config_value)||150,d=await e.env.DB.prepare(`
      SELECT * FROM weekly_gift_tracking WHERE user_id = ? AND year_week = ?
    `).bind(r,o).first(),c=(d==null?void 0:d.total_gifted)||0,m=(d==null?void 0:d.gift_count)||0,f=u-c;return e.json({success:!0,yearWeek:o,weeklyLimit:u,totalGifted:c,remaining:f,giftCount:m,lastGiftAt:(d==null?void 0:d.last_gift_at)||null,limitReached:c>=u,percentageUsed:Math.round(c/u*100)})}catch(r){return console.error("Get weekly gift status error:",r),e.json({error:"Failed to get weekly gift status"},500)}});p.get("/api/tokens/history/:userId",async e=>{try{const r=e.req.param("userId"),{results:t}=await e.env.DB.prepare(`
      SELECT 
        t.*,
    ...
    `).bind(r).first();return e.json({success:!0,count:(t==null?void 0:t.count)||0})}catch(r){return console.error("Get unread count error:",r),e.json({error:"Failed to get unread count"},500)}});p.get("/api/notifications/:userId/unread",async e=>{try{const r=e.req.param("userId"),{results:t}=await e.env.DB.prepare(`
      ...
      ORDER BY created_at DESC
      LIMIT 10
    `).bind(r).all();return e.json({success:!0,notifications:t||[]})}catch(r){return console.error("Get unread notifications error:",r),e.json({error:"Failed to get unread notifications"},500)}});p.get("/api/data/plans",async e=>{try{const r=e.req.query("network");let t="SELECT * FROM data_plans WHERE active = 1";const s=[];r&&(t+=" AND network = ?",s.push(r)),t+=" ORDER BY token_cost ASC";const n=await e.env.DB.prepare(t).bind(...s).all();return e.json({success:!0,data:n.results||[]})}catch(r){return console.error("Get data plans error:",r),e.json({error:"Failed to get data plans"},500)}});p.post("/api/data/redeem",async e=>{var r,t,s,n,a,o,i;try{const{userId:u,planCode:d,phoneNumber:c}=await e.req.json();if(!u||!d||!c)return e.json({error:"User ID, plan code, and phone number required"},400);if(!/^0[789][01]\d{8}$/.test(c))return e.json({error:"Invalid Nigerian phone number format"},400);const f=await e.env.DB.prepare(`
      SELECT * FROM data_plans WHERE plan_code = ? AND active = 1
    `).bind(d).first();if(!f)return e.json({error:"Data plan not found"},404);const E=await e.env.DB.prepare(`
      SELECT tokens, email, phone_number FROM users WHERE id = ?
    `).bind(u).first();if(!E)return e.json({error:"User not found"},404);if(E.tokens<f.token_cost)return e.json({error:"Insufficient tokens",required:f.token_cost,current:E.tokens},400);const h=crypto.randomUUID();await e.env.DB.prepare(`
      INSERT INTO data_redemptions (
        user_id, phone_number, network, data_plan, 
        data_amount, token_cost, status, transaction_id
      ) VALUES (?, ?, ?, ?, ?, ?, 'pending', ?)
    `).bind(u,c,f.network,f.plan_code,f.data_amount,f.token_cost,h).run(),await e.env.DB.prepare(`
      UPDATE users 
      SET tokens = tokens - ?,
          total_spent = total_spent + ?
      WHERE id = ?
    `).bind(f.token_cost,f.token_cost,u).run();let v="pending",_=null,T=null;const R=e.env.VTPASS_API_KEY,I=e.env.VTPASS_PUBLIC_KEY,U=e.env.VTPASS_SECRET_KEY,D=e.env.VTPASS_BASE_URL||"https://sandbox.vtpass.com/api";if(R&&I&&U)try{const L={MTN:"mtn-data",Airtel:"airtel-data",Glo:"glo-data","9mobile":"etisalat-data"}[f.network]||"mtn-data",N=`SCPAY-${Date.now()}-${Math.floor(Math.random()*1e4)}`;console.log(`[VTPASS] Purchasing ${f.data_amount} ${f.network} data for ${c}`);const x=await fetch(`${D}/pay`,{method:"POST",headers:{"api-key":R,"secret-key":U,"Content-Type":"application/json"},body:JSON.stringify({request_id:N,serviceID:L,billersCode:c,variation_code:f.plan_code,amount:parseInt(f.variation_amount||"0"),phone:c})});if(!x.ok)throw new Error(`VTPass API error: ${x.status} ${x.statusText}`);const O=await x.json();console.log(`[VTPASS] Response code: ${O.code}, status: ${(t=(r=O.content)==null?void 0:r.transactions)==null?void 0:t.status}`);const H=(a=(n=(s=O.content)==null?void 0:s.transactions)==null?void 0:n.status)==null?void 0:a.toLowerCase();H==="delivered"||H==="successful"?v="completed":H==="failed"||H==="reversed"?(v="failed",T=O.response_description||"Transaction failed"):v="pending",_=((i=(o=O.content)==null?void 0:o.transactions)==null?void 0:i.transactionId)||N,console.log(`[VTPASS] Transaction ${h} status: ${v}`)}catch(ee){console.error("[VTPASS] API error:",ee),v="failed",T=ee.message||"VTPass API error",await e.env.DB.prepare(`
          UPDATE users 
          SET tokens = tokens + ?,
              total_spent = total_spent - ?
          WHERE id = ?
        `).bind(f.token_cost,f.token_cost,u).run(),console.log(`[VTPASS] Refunded ${f.token_cost} tokens to user ${u} due to API error`)}else console.log("[DATA REDEMPTION] DEMO MODE - VTPass API keys not configured"),v="completed",_="DEMO-"+Date.now();await e.env.DB.prepare(`
    ...
    `).bind(v,_,T,v!=="pending"?new Date().toISOString():null,h).run(),console.log(`[DATA REDEMPTION] User ${u} redeemed ${f.data_amount} ${f.network} data for ${f.token_cost} tokens`),await e.env.DB.prepare(`
      INSERT INTO notifications (user_id, type, title, message)
      VALUES (?, 'data_redeemed', 'Data Redeemed!', ?)
    `).bind(u,`${f.data_amount} ${f.network} data sent to ${c}`).run();const Z=await e.env.DB.prepare(`
      SELECT tokens FROM users WHERE id = ?
    `).bind(u).first();return e.json({success:!0,transactionId:h,message:`${f.data_amount} data will be sent to ${c} shortly`,newBalance:(Z==null?void 0:Z.tokens)||0,redemption:{network:f.network,dataAmount:f.data_amount,phoneNumber:c,status:v}})}catch(u){return console.error("Data redemption error:",u),e.json({error:"Failed to redeem data"},500)}});p.get("/api/data/history/:userId",async e=>{try{const r=e.req.param("userId"),t=parseInt(e.req.query("limit")||"20"),s=await e.env.DB.prepare(`
      SELECT 
    ...
    `).bind(r).first();return t?(console.log(`[ADS] Advertiser logged in: ${r}`),e.json({success:!0,advertiserId:t.id,businessName:t.business_name,email:t.email,phone:t.phone,instagramHandle:t.instagram_handle,websiteUrl:t.website_url,message:"Login successful"})):e.json({error:"Account not found. Please register first."},404)}catch(r){return console.error("[ADS] Login error:",r),e.json({error:"Login failed"},500)}});p.post("/api/ads/create-campaign",async e=>{try{const{advertiserId:r,campaignName:t,adImageUrl:s,adTitle:n,adDescription:a,destinationType:o,instagramHandle:i,websiteUrl:u,pricingModel:d,budgetTotal:c,startDate:m,endDate:f}=await e.req.json();if(!r||!t||!s||!n||!o||!d||!c)return e.json({error:"Missing required fields"},400);if(o==="instagram"&&!i)return e.json({error:"Instagram handle required for Instagram destination"},400);if(o==="website"&&!u)return e.json({error:"Website URL required for website destination"},400);if(c<2e3)return e.json({error:"Minimum budget is ₦2,000"},400);const E=crypto.randomUUID();return await e.env.DB.prepare(`
    ...
    `).bind(E,r,t,s,n,a||null,o,i||null,u||null,d,c,m||new Date().toISOString(),f||null).run(),console.log(`[ADS] Campaign created: ${t} by advertiser ${r}`),e.json({success:!0,campaignId:E,message:"Campaign created and activated!",status:"active"})}catch(r){return console.error("[ADS] Campaign creation error:",r),e.json({error:"Campaign creation failed"},500)}});p.put("/api/ads/update-campaign/:campaignId",async e=>{try{const r=e.req.param("campaignId"),{campaignName:t,adImageUrl:s,adTitle:n,adDescription:a,destinationType:o,instagramHandle:i,websiteUrl:u,budgetTotal:d}=await e.req.json(),c=await e.env.DB.prepare(`
      SELECT id, advertiser_id, budget_spent FROM ad_campaigns WHERE id = ?
    `).bind(r).first();if(!c)return e.json({error:"Campaign not found"},404);if(!t||!s||!n||!o)return e.json({error:"Missing required fields"},400);if(o==="instagram"&&!i)return e.json({error:"Instagram handle required for Instagram destination"},400);if(o==="website"&&!u)return e.json({error:"Website URL required for website destination"},400);if(d&&d<c.budget_spent)return e.json({error:`Budget cannot be less than already spent (₦${c.budget_spent})`},400);const m=[],f=[];return t&&(m.push("campaign_name = ?"),f.push(t)),s&&(m.push("ad_image_url = ?"),f.push(s)),n&&(m.push("ad_title = ?"),f.push(n)),a!==void 0&&(m.push("ad_description = ?"),f.push(a||null)),o&&(m.push("destination_type = ?"),f.push(o)),i!==void 0&&(m.push("instagram_handle = ?"),f.push(i||null)),u!==void 0&&(m.push("website_url = ?"),f.push(u||null)),d&&(m.push("budget_total = ?"),f.push(d)),f.push(r),await e.env.DB.prepare(`
      UPDATE ad_campaigns 
      SET ${m.join(", ")}
      WHERE id = ?
    ...
    `).bind(r,t||null,s||null).run(),await e.env.DB.prepare(`
      ...
      WHERE id = ?
    `).bind(i,o,r).run();let u="";return n.destination_type==="instagram"?u=`https://instagram.com/${n.instagram_handle}`:u=n.website_url,e.json({success:!0,clickRecorded:!0,destinationUrl:u})}catch(r){return console.error("[ADS] Click tracking error:",r),e.json({error:"Failed to track click"},500)}});p.get("/api/ads/campaign/:campaignId/analytics",async e=>{try{const r=e.req.param("campaignId"),t=await e.env.DB.prepare(`
      SELECT 
    ...
    `).bind(r).first();if(!o||o.created_by!==t)return e.json({error:"Only group admin can update info"},403);const i=[],u=[];return s!==void 0&&(i.push("room_name = ?"),u.push(s)),n!==void 0&&(i.push("description = ?"),u.push(n||null)),a!==void 0&&(i.push("avatar = ?"),u.push(a||null)),i.length===0?e.json({error:"No fields to update"},400):(i.push("updated_at = CURRENT_TIMESTAMP"),u.push(r),await e.env.DB.prepare(`
      UPDATE chat_rooms 
      SET ${i.join(", ")}
      WHERE id = ?
    `).bind(...u).run(),e.json({success:!0}))}catch(r){return console.error("[PROFILE] Update group error:",r),e.json({error:"Failed to update group"},500)}});p.post("/api/profile/group/permissions",async e=>{try{const{roomId:r,userId:t,permission:s,value:n}=await e.req.json();if(!r||!t||!s)return e.json({error:"Missing required fields"},400);const a=await e.env.DB.prepare(`
      SELECT created_by FROM chat_rooms WHERE id = ?
