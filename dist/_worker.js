var Tr=Object.defineProperty;var $e=e=>{throw TypeError(e)};var Dr=(e,r,t)=>r in e?Tr(e,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[r]=t;var g=(e,r,t)=>Dr(e,typeof r!="symbol"?r+"":r,t),Fe=(e,r,t)=>r.has(e)||$e("Cannot "+t);var l=(e,r,t)=>(Fe(e,r,"read from private field"),t?t.call(e):r.get(e)),v=(e,r,t)=>r.has(e)?$e("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,t),_=(e,r,t,s)=>(Fe(e,r,"write to private field"),s?s.call(e,t):r.set(e,t),t),b=(e,r,t)=>(Fe(e,r,"access private method"),t);var Ve=(e,r,t,s)=>({set _(n){_(e,r,n,t)},get _(){return l(e,r,s)}});var Ye=(e,r,t)=>(s,n)=>{let a=-1;return o(0);async function o(i){if(i<=a)throw new Error("next() called multiple times");a=i;let d,u=!1,c;if(e[i]?(c=e[i][0][0],s.req.routeIndex=i):c=i===e.length&&n||void 0,c)try{d=await c(s,()=>o(i+1))}catch(f){if(f instanceof Error&&r)s.error=f,d=await r(f,s),u=!0;else throw f}else s.finalized===!1&&t&&(d=await t(s));return d&&(s.finalized===!1||u)&&(s.res=d),s}},Sr=Symbol(),jr=async(e,r=Object.create(null))=>{const{all:t=!1,dot:s=!1}=r,a=(e instanceof dr?e.raw.headers:e.headers).get("Content-Type");return a!=null&&a.startsWith("multipart/form-data")||a!=null&&a.startsWith("application/x-www-form-urlencoded")?Ar(e,{all:t,dot:s}):{}};async function Ar(e,r){const t=await e.formData();return t?Or(t,r):{}}function Or(e,r){const t=Object.create(null);return e.forEach((s,n)=>{r.all||n.endsWith("[]")?kr(t,n,s):t[n]=s}),r.dot&&Object.entries(t).forEach(([s,n])=>{s.includes(".")&&(Cr(t,s,n),delete t[s])}),t}var kr=(e,r,t)=>{e[r]!==void 0?Array.isArray(e[r])?e[r].push(t):e[r]=[e[r],t]:r.endsWith("[]")?e[r]=[t]:e[r]=t},Cr=(e,r,t)=>{let s=e;const n=r.split(".");n.forEach((a,o)=>{o===n.length-1?s[a]=t:((!s[a]||typeof s[a]!="object"||Array.isArray(s[a])||s[a]instanceof File)&&(s[a]=Object.create(null)),s=s[a])})},sr=e=>{const r=e.split("/");return r[0]===""&&r.shift(),r},Nr=e=>{const{groups:r,path:t}=Ur(e),s=sr(t);return Lr(s,r)},Ur=e=>{const r=[];return e=e.replace(/\{[^}]+\}/g,(t,s)=>{const n=`@${s}`;return r.push([n,t]),n}),{groups:r,path:e}},Lr=(e,r)=>{for(let t=r.length-1;t>=0;t--){const[s]=r[t];for(let n=e.length-1;n>=0;n--)if(e[n].includes(s)){e[n]=e[n].replace(s,r[t][1]);break}}return e},Oe={},xr=(e,r)=>{if(e==="*")return"*";const t=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(t){const s=`${e}#${r}`;return Oe[s]||(t[2]?Oe[s]=r&&r[0]!==":"&&r[0]!=="*"?[s,t[1],new RegExp(`^${t[2]}(?=/${r})`)]:[e,t[1],new RegExp(`^${t[2]}$`)]:Oe[s]=[e,t[1],!0]),Oe[s]}return null},We=(e,r)=>{try{return r(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,t=>{try{return r(t)}catch{return t}})}},Pr=e=>We(e,decodeURI),nr=e=>{const r=e.url,t=r.indexOf("/",r.indexOf(":")+4);let s=t;for(;s<r.length;s++){const n=r.charCodeAt(s);if(n===37){const a=r.indexOf("?",s),o=r.slice(t,a===-1?void 0:a);return Pr(o.includes("%25")?o.replace(/%25/g,"%2525"):o)}else if(n===63)break}return r.slice(t,s)},Fr=e=>{const r=nr(e);return r.length>1&&r.at(-1)==="/"?r.slice(0,-1):r},le=(e,r,...t)=>(t.length&&(r=le(r,...t)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${r==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(r==null?void 0:r[0])==="/"?r.slice(1):r}`}`),ar=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const r=e.split("/"),t=[];let s="";return r.forEach(n=>{if(n!==""&&!/\:/.test(n))s+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){t.length===0&&s===""?t.push("/"):t.push(s);const a=n.replace("?","");s+="/"+a,t.push(s)}else s+="/"+n}),t.filter((n,a,o)=>o.indexOf(n)===a)},Me=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?We(e,ir):e):e,or=(e,r,t)=>{let s;if(!t&&r&&!/[%+]/.test(r)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(r,o+1)||(o=e.indexOf(`&${r}`,o+1));o!==-1;){const i=e.charCodeAt(o+r.length+1);if(i===61){const d=o+r.length+2,u=e.indexOf("&",d);return Me(e.slice(d,u===-1?void 0:u))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${r}`,o+1)}if(s=/[%+]/.test(e),!s)return}const n={};s??(s=/[%+]/.test(e));let a=e.indexOf("?",8);for(;a!==-1;){const o=e.indexOf("&",a+1);let i=e.indexOf("=",a);i>o&&o!==-1&&(i=-1);let d=e.slice(a+1,i===-1?o===-1?void 0:o:i);if(s&&(d=Me(d)),a=o,d==="")continue;let u;i===-1?u="":(u=e.slice(i+1,o===-1?void 0:o),s&&(u=Me(u))),t?(n[d]&&Array.isArray(n[d])||(n[d]=[]),n[d].push(u)):n[d]??(n[d]=u)}return r?n[r]:n},Mr=or,Br=(e,r)=>or(e,r,!0),ir=decodeURIComponent,Ge=e=>We(e,ir),fe,P,Y,ur,cr,He,G,Xe,dr=(Xe=class{constructor(e,r="/",t=[[]]){v(this,Y);g(this,"raw");v(this,fe);v(this,P);g(this,"routeIndex",0);g(this,"path");g(this,"bodyCache",{});v(this,G,e=>{const{bodyCache:r,raw:t}=this,s=r[e];if(s)return s;const n=Object.keys(r)[0];return n?r[n].then(a=>(n==="json"&&(a=JSON.stringify(a)),new Response(a)[e]())):r[e]=t[e]()});this.raw=e,this.path=r,_(this,P,t),_(this,fe,{})}param(e){return e?b(this,Y,ur).call(this,e):b(this,Y,cr).call(this)}query(e){return Mr(this.url,e)}queries(e){return Br(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const r={};return this.raw.headers.forEach((t,s)=>{r[s]=t}),r}async parseBody(e){var r;return(r=this.bodyCache).parsedBody??(r.parsedBody=await jr(this,e))}json(){return l(this,G).call(this,"text").then(e=>JSON.parse(e))}text(){return l(this,G).call(this,"text")}arrayBuffer(){return l(this,G).call(this,"arrayBuffer")}blob(){return l(this,G).call(this,"blob")}formData(){return l(this,G).call(this,"formData")}addValidatedData(e,r){l(this,fe)[e]=r}valid(e){return l(this,fe)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Sr](){return l(this,P)}get matchedRoutes(){return l(this,P)[0].map(([[,e]])=>e)}get routePath(){return l(this,P)[0].map(([[,e]])=>e)[this.routeIndex].path}},fe=new WeakMap,P=new WeakMap,Y=new WeakSet,ur=function(e){const r=l(this,P)[0][this.routeIndex][1][e],t=b(this,Y,He).call(this,r);return t&&/\%/.test(t)?Ge(t):t},cr=function(){const e={},r=Object.keys(l(this,P)[0][this.routeIndex][1]);for(const t of r){const s=b(this,Y,He).call(this,l(this,P)[0][this.routeIndex][1][t]);s!==void 0&&(e[t]=/\%/.test(s)?Ge(s):s)}return e},He=function(e){return l(this,P)[1]?l(this,P)[1][e]:e},G=new WeakMap,Xe),Hr={Stringify:1},lr=async(e,r,t,s,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const a=e.callbacks;return a!=null&&a.length?(n?n[0]+=e:n=[e],Promise.all(a.map(i=>i({phase:r,buffer:n,context:s}))).then(i=>Promise.all(i.filter(Boolean).map(d=>lr(d,r,!1,s,n))).then(()=>n[0]))):Promise.resolve(e)},qr="text/plain; charset=UTF-8",Be=(e,r)=>({"Content-Type":e,...r}),Ie,Te,q,he,W,C,De,Ee,_e,se,Se,je,K,pe,Qe,Wr=(Qe=class{constructor(e,r){v(this,K);v(this,Ie);v(this,Te);g(this,"env",{});v(this,q);g(this,"finalized",!1);g(this,"error");v(this,he);v(this,W);v(this,C);v(this,De);v(this,Ee);v(this,_e);v(this,se);v(this,Se);v(this,je);g(this,"render",(...e)=>(l(this,Ee)??_(this,Ee,r=>this.html(r)),l(this,Ee).call(this,...e)));g(this,"setLayout",e=>_(this,De,e));g(this,"getLayout",()=>l(this,De));g(this,"setRenderer",e=>{_(this,Ee,e)});g(this,"header",(e,r,t)=>{this.finalized&&_(this,C,new Response(l(this,C).body,l(this,C)));const s=l(this,C)?l(this,C).headers:l(this,se)??_(this,se,new Headers);r===void 0?s.delete(e):t!=null&&t.append?s.append(e,r):s.set(e,r)});g(this,"status",e=>{_(this,he,e)});g(this,"set",(e,r)=>{l(this,q)??_(this,q,new Map),l(this,q).set(e,r)});g(this,"get",e=>l(this,q)?l(this,q).get(e):void 0);g(this,"newResponse",(...e)=>b(this,K,pe).call(this,...e));g(this,"body",(e,r,t)=>b(this,K,pe).call(this,e,r,t));g(this,"text",(e,r,t)=>!l(this,se)&&!l(this,he)&&!r&&!t&&!this.finalized?new Response(e):b(this,K,pe).call(this,e,r,Be(qr,t)));g(this,"json",(e,r,t)=>b(this,K,pe).call(this,JSON.stringify(e),r,Be("application/json",t)));g(this,"html",(e,r,t)=>{const s=n=>b(this,K,pe).call(this,n,r,Be("text/html; charset=UTF-8",t));return typeof e=="object"?lr(e,Hr.Stringify,!1,{}).then(s):s(e)});g(this,"redirect",(e,r)=>{const t=String(e);return this.header("Location",/[^\x00-\xFF]/.test(t)?encodeURI(t):t),this.newResponse(null,r??302)});g(this,"notFound",()=>(l(this,_e)??_(this,_e,()=>new Response),l(this,_e).call(this,this)));_(this,Ie,e),r&&(_(this,W,r.executionCtx),this.env=r.env,_(this,_e,r.notFoundHandler),_(this,je,r.path),_(this,Se,r.matchResult))}get req(){return l(this,Te)??_(this,Te,new dr(l(this,Ie),l(this,je),l(this,Se))),l(this,Te)}get event(){if(l(this,W)&&"respondWith"in l(this,W))return l(this,W);throw Error("This context has no FetchEvent")}get executionCtx(){if(l(this,W))return l(this,W);throw Error("This context has no ExecutionContext")}get res(){return l(this,C)||_(this,C,new Response(null,{headers:l(this,se)??_(this,se,new Headers)}))}set res(e){if(l(this,C)&&e){e=new Response(e.body,e);for(const[r,t]of l(this,C).headers.entries())if(r!=="content-type")if(r==="set-cookie"){const s=l(this,C).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of s)e.headers.append("set-cookie",n)}else e.headers.set(r,t)}_(this,C,e),this.finalized=!0}get var(){return l(this,q)?Object.fromEntries(l(this,q)):{}}},Ie=new WeakMap,Te=new WeakMap,q=new WeakMap,he=new WeakMap,W=new WeakMap,C=new WeakMap,De=new WeakMap,Ee=new WeakMap,_e=new WeakMap,se=new WeakMap,Se=new WeakMap,je=new WeakMap,K=new WeakSet,pe=function(e,r,t){const s=l(this,C)?new Headers(l(this,C).headers):l(this,se)??new Headers;if(typeof r=="object"&&"headers"in r){const a=r.headers instanceof Headers?r.headers:new Headers(r.headers);for(const[o,i]of a)o.toLowerCase()==="set-cookie"?s.append(o,i):s.set(o,i)}if(t)for(const[a,o]of Object.entries(t))if(typeof o=="string")s.set(a,o);else{s.delete(a);for(const i of o)s.append(a,i)}const n=typeof r=="number"?r:(r==null?void 0:r.status)??l(this,he);return new Response(e,{status:n,headers:s})},Qe),T="ALL",$r="all",Vr=["get","post","put","delete","options","patch"],pr="Can not add a route since the matcher is already built.",mr=class extends Error{},Yr="__COMPOSED_HANDLER",Gr=e=>e.text("404 Not Found",404),Ke=(e,r)=>{if("getResponse"in e){const t=e.getResponse();return r.newResponse(t.body,t)}return console.error(e),r.text("Internal Server Error",500)},F,D,fr,M,re,ke,Ce,ge,Kr=(ge=class{constructor(r={}){v(this,D);g(this,"get");g(this,"post");g(this,"put");g(this,"delete");g(this,"options");g(this,"patch");g(this,"all");g(this,"on");g(this,"use");g(this,"router");g(this,"getPath");g(this,"_basePath","/");v(this,F,"/");g(this,"routes",[]);v(this,M,Gr);g(this,"errorHandler",Ke);g(this,"onError",r=>(this.errorHandler=r,this));g(this,"notFound",r=>(_(this,M,r),this));g(this,"fetch",(r,...t)=>b(this,D,Ce).call(this,r,t[1],t[0],r.method));g(this,"request",(r,t,s,n)=>r instanceof Request?this.fetch(t?new Request(r,t):r,s,n):(r=r.toString(),this.fetch(new Request(/^https?:\/\//.test(r)?r:`http://localhost${le("/",r)}`,t),s,n)));g(this,"fire",()=>{addEventListener("fetch",r=>{r.respondWith(b(this,D,Ce).call(this,r.request,r,void 0,r.request.method))})});[...Vr,$r].forEach(a=>{this[a]=(o,...i)=>(typeof o=="string"?_(this,F,o):b(this,D,re).call(this,a,l(this,F),o),i.forEach(d=>{b(this,D,re).call(this,a,l(this,F),d)}),this)}),this.on=(a,o,...i)=>{for(const d of[o].flat()){_(this,F,d);for(const u of[a].flat())i.map(c=>{b(this,D,re).call(this,u.toUpperCase(),l(this,F),c)})}return this},this.use=(a,...o)=>(typeof a=="string"?_(this,F,a):(_(this,F,"*"),o.unshift(a)),o.forEach(i=>{b(this,D,re).call(this,T,l(this,F),i)}),this);const{strict:s,...n}=r;Object.assign(this,n),this.getPath=s??!0?r.getPath??nr:Fr}route(r,t){const s=this.basePath(r);return t.routes.map(n=>{var o;let a;t.errorHandler===Ke?a=n.handler:(a=async(i,d)=>(await Ye([],t.errorHandler)(i,()=>n.handler(i,d))).res,a[Yr]=n.handler),b(o=s,D,re).call(o,n.method,n.path,a)}),this}basePath(r){const t=b(this,D,fr).call(this);return t._basePath=le(this._basePath,r),t}mount(r,t,s){let n,a;s&&(typeof s=="function"?a=s:(a=s.optionHandler,s.replaceRequest===!1?n=d=>d:n=s.replaceRequest));const o=a?d=>{const u=a(d);return Array.isArray(u)?u:[u]}:d=>{let u;try{u=d.executionCtx}catch{}return[d.env,u]};n||(n=(()=>{const d=le(this._basePath,r),u=d==="/"?0:d.length;return c=>{const f=new URL(c.url);return f.pathname=f.pathname.slice(u)||"/",new Request(f,c)}})());const i=async(d,u)=>{const c=await t(n(d.req.raw),...o(d));if(c)return c;await u()};return b(this,D,re).call(this,T,le(r,"*"),i),this}},F=new WeakMap,D=new WeakSet,fr=function(){const r=new ge({router:this.router,getPath:this.getPath});return r.errorHandler=this.errorHandler,_(r,M,l(this,M)),r.routes=this.routes,r},M=new WeakMap,re=function(r,t,s){r=r.toUpperCase(),t=le(this._basePath,t);const n={basePath:this._basePath,path:t,method:r,handler:s};this.router.add(r,t,[s,n]),this.routes.push(n)},ke=function(r,t){if(r instanceof Error)return this.errorHandler(r,t);throw r},Ce=function(r,t,s,n){if(n==="HEAD")return(async()=>new Response(null,await b(this,D,Ce).call(this,r,t,s,"GET")))();const a=this.getPath(r,{env:s}),o=this.router.match(n,a),i=new Wr(r,{path:a,matchResult:o,env:s,executionCtx:t,notFoundHandler:l(this,M)});if(o[0].length===1){let u;try{u=o[0][0][0][0](i,async()=>{i.res=await l(this,M).call(this,i)})}catch(c){return b(this,D,ke).call(this,c,i)}return u instanceof Promise?u.then(c=>c||(i.finalized?i.res:l(this,M).call(this,i))).catch(c=>b(this,D,ke).call(this,c,i)):u??l(this,M).call(this,i)}const d=Ye(o[0],this.errorHandler,l(this,M));return(async()=>{try{const u=await d(i);if(!u.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return u.res}catch(u){return b(this,D,ke).call(this,u,i)}})()},ge),hr=[];function Jr(e,r){const t=this.buildAllMatchers(),s=((n,a)=>{const o=t[n]||t[T],i=o[2][a];if(i)return i;const d=a.match(o[0]);if(!d)return[[],hr];const u=d.indexOf("",1);return[o[1][u],d]});return this.match=s,s(e,r)}var Ue="[^/]+",be=".*",Re="(?:|/.*)",me=Symbol(),zr=new Set(".\\+*[^]$()");function Xr(e,r){return e.length===1?r.length===1?e<r?-1:1:-1:r.length===1||e===be||e===Re?1:r===be||r===Re?-1:e===Ue?1:r===Ue?-1:e.length===r.length?e<r?-1:1:r.length-e.length}var ne,ae,B,de,Qr=(de=class{constructor(){v(this,ne);v(this,ae);v(this,B,Object.create(null))}insert(r,t,s,n,a){if(r.length===0){if(l(this,ne)!==void 0)throw me;if(a)return;_(this,ne,t);return}const[o,...i]=r,d=o==="*"?i.length===0?["","",be]:["","",Ue]:o==="/*"?["","",Re]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let u;if(d){const c=d[1];let f=d[2]||Ue;if(c&&d[2]&&(f===".*"||(f=f.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(f))))throw me;if(u=l(this,B)[f],!u){if(Object.keys(l(this,B)).some(p=>p!==be&&p!==Re))throw me;if(a)return;u=l(this,B)[f]=new de,c!==""&&_(u,ae,n.varIndex++)}!a&&c!==""&&s.push([c,l(u,ae)])}else if(u=l(this,B)[o],!u){if(Object.keys(l(this,B)).some(c=>c.length>1&&c!==be&&c!==Re))throw me;if(a)return;u=l(this,B)[o]=new de}u.insert(i,t,s,n,a)}buildRegExpStr(){const t=Object.keys(l(this,B)).sort(Xr).map(s=>{const n=l(this,B)[s];return(typeof l(n,ae)=="number"?`(${s})@${l(n,ae)}`:zr.has(s)?`\\${s}`:s)+n.buildRegExpStr()});return typeof l(this,ne)=="number"&&t.unshift(`#${l(this,ne)}`),t.length===0?"":t.length===1?t[0]:"(?:"+t.join("|")+")"}},ne=new WeakMap,ae=new WeakMap,B=new WeakMap,de),Le,Ae,Ze,Zr=(Ze=class{constructor(){v(this,Le,{varIndex:0});v(this,Ae,new Qr)}insert(e,r,t){const s=[],n=[];for(let o=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,d=>{const u=`@\\${o}`;return n[o]=[u,d],o++,i=!0,u}),!i)break}const a=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=n.length-1;o>=0;o--){const[i]=n[o];for(let d=a.length-1;d>=0;d--)if(a[d].indexOf(i)!==-1){a[d]=a[d].replace(i,n[o][1]);break}}return l(this,Ae).insert(a,r,s,l(this,Le),t),s}buildRegExp(){let e=l(this,Ae).buildRegExpStr();if(e==="")return[/^$/,[],[]];let r=0;const t=[],s=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,a,o)=>a!==void 0?(t[++r]=Number(a),"$()"):(o!==void 0&&(s[Number(o)]=++r),"")),[new RegExp(`^${e}`),t,s]}},Le=new WeakMap,Ae=new WeakMap,Ze),et=[/^$/,[],Object.create(null)],Ne=Object.create(null);function Er(e){return Ne[e]??(Ne[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(r,t)=>t?`\\${t}`:"(?:|/.*)")}$`))}function rt(){Ne=Object.create(null)}function tt(e){var u;const r=new Zr,t=[];if(e.length===0)return et;const s=e.map(c=>[!/\*|\/:/.test(c[0]),...c]).sort(([c,f],[p,h])=>c?1:p?-1:f.length-h.length),n=Object.create(null);for(let c=0,f=-1,p=s.length;c<p;c++){const[h,E,y]=s[c];h?n[E]=[y.map(([R])=>[R,Object.create(null)]),hr]:f++;let w;try{w=r.insert(E,f,h)}catch(R){throw R===me?new mr(E):R}h||(t[f]=y.map(([R,k])=>{const S=Object.create(null);for(k-=1;k>=0;k--){const[U,I]=w[k];S[U]=I}return[R,S]}))}const[a,o,i]=r.buildRegExp();for(let c=0,f=t.length;c<f;c++)for(let p=0,h=t[c].length;p<h;p++){const E=(u=t[c][p])==null?void 0:u[1];if(!E)continue;const y=Object.keys(E);for(let w=0,R=y.length;w<R;w++)E[y[w]]=i[E[y[w]]]}const d=[];for(const c in o)d[c]=t[o[c]];return[a,d,n]}function ce(e,r){if(e){for(const t of Object.keys(e).sort((s,n)=>n.length-s.length))if(Er(t).test(r))return[...e[t]]}}var J,z,xe,_r,er,st=(er=class{constructor(){v(this,xe);g(this,"name","RegExpRouter");v(this,J);v(this,z);g(this,"match",Jr);_(this,J,{[T]:Object.create(null)}),_(this,z,{[T]:Object.create(null)})}add(e,r,t){var i;const s=l(this,J),n=l(this,z);if(!s||!n)throw new Error(pr);s[e]||[s,n].forEach(d=>{d[e]=Object.create(null),Object.keys(d[T]).forEach(u=>{d[e][u]=[...d[T][u]]})}),r==="/*"&&(r="*");const a=(r.match(/\/:/g)||[]).length;if(/\*$/.test(r)){const d=Er(r);e===T?Object.keys(s).forEach(u=>{var c;(c=s[u])[r]||(c[r]=ce(s[u],r)||ce(s[T],r)||[])}):(i=s[e])[r]||(i[r]=ce(s[e],r)||ce(s[T],r)||[]),Object.keys(s).forEach(u=>{(e===T||e===u)&&Object.keys(s[u]).forEach(c=>{d.test(c)&&s[u][c].push([t,a])})}),Object.keys(n).forEach(u=>{(e===T||e===u)&&Object.keys(n[u]).forEach(c=>d.test(c)&&n[u][c].push([t,a]))});return}const o=ar(r)||[r];for(let d=0,u=o.length;d<u;d++){const c=o[d];Object.keys(n).forEach(f=>{var p;(e===T||e===f)&&((p=n[f])[c]||(p[c]=[...ce(s[f],c)||ce(s[T],c)||[]]),n[f][c].push([t,a-u+d+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(l(this,z)).concat(Object.keys(l(this,J))).forEach(r=>{e[r]||(e[r]=b(this,xe,_r).call(this,r))}),_(this,J,_(this,z,void 0)),rt(),e}},J=new WeakMap,z=new WeakMap,xe=new WeakSet,_r=function(e){const r=[];let t=e===T;return[l(this,J),l(this,z)].forEach(s=>{const n=s[e]?Object.keys(s[e]).map(a=>[a,s[e][a]]):[];n.length!==0?(t||(t=!0),r.push(...n)):e!==T&&r.push(...Object.keys(s[T]).map(a=>[a,s[T][a]]))}),t?tt(r):null},er),X,$,rr,nt=(rr=class{constructor(e){g(this,"name","SmartRouter");v(this,X,[]);v(this,$,[]);_(this,X,e.routers)}add(e,r,t){if(!l(this,$))throw new Error(pr);l(this,$).push([e,r,t])}match(e,r){if(!l(this,$))throw new Error("Fatal error");const t=l(this,X),s=l(this,$),n=t.length;let a=0,o;for(;a<n;a++){const i=t[a];try{for(let d=0,u=s.length;d<u;d++)i.add(...s[d]);o=i.match(e,r)}catch(d){if(d instanceof mr)continue;throw d}this.match=i.match.bind(i),_(this,X,[i]),_(this,$,void 0);break}if(a===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(l(this,$)||l(this,X).length!==1)throw new Error("No active router has been determined yet.");return l(this,X)[0]}},X=new WeakMap,$=new WeakMap,rr),ve=Object.create(null),Q,O,oe,ye,j,V,te,we,at=(we=class{constructor(r,t,s){v(this,V);v(this,Q);v(this,O);v(this,oe);v(this,ye,0);v(this,j,ve);if(_(this,O,s||Object.create(null)),_(this,Q,[]),r&&t){const n=Object.create(null);n[r]={handler:t,possibleKeys:[],score:0},_(this,Q,[n])}_(this,oe,[])}insert(r,t,s){_(this,ye,++Ve(this,ye)._);let n=this;const a=Nr(t),o=[];for(let i=0,d=a.length;i<d;i++){const u=a[i],c=a[i+1],f=xr(u,c),p=Array.isArray(f)?f[0]:u;if(p in l(n,O)){n=l(n,O)[p],f&&o.push(f[1]);continue}l(n,O)[p]=new we,f&&(l(n,oe).push(f),o.push(f[1])),n=l(n,O)[p]}return l(n,Q).push({[r]:{handler:s,possibleKeys:o.filter((i,d,u)=>u.indexOf(i)===d),score:l(this,ye)}}),n}search(r,t){var d;const s=[];_(this,j,ve);let a=[this];const o=sr(t),i=[];for(let u=0,c=o.length;u<c;u++){const f=o[u],p=u===c-1,h=[];for(let E=0,y=a.length;E<y;E++){const w=a[E],R=l(w,O)[f];R&&(_(R,j,l(w,j)),p?(l(R,O)["*"]&&s.push(...b(this,V,te).call(this,l(R,O)["*"],r,l(w,j))),s.push(...b(this,V,te).call(this,R,r,l(w,j)))):h.push(R));for(let k=0,S=l(w,oe).length;k<S;k++){const U=l(w,oe)[k],I=l(w,j)===ve?{}:{...l(w,j)};if(U==="*"){const A=l(w,O)["*"];A&&(s.push(...b(this,V,te).call(this,A,r,l(w,j))),_(A,j,I),h.push(A));continue}const[Z,ee,L]=U;if(!f&&!(L instanceof RegExp))continue;const N=l(w,O)[Z],x=o.slice(u).join("/");if(L instanceof RegExp){const A=L.exec(x);if(A){if(I[ee]=A[0],s.push(...b(this,V,te).call(this,N,r,l(w,j),I)),Object.keys(l(N,O)).length){_(N,j,I);const H=((d=A[0].match(/\//))==null?void 0:d.length)??0;(i[H]||(i[H]=[])).push(N)}continue}}(L===!0||L.test(f))&&(I[ee]=f,p?(s.push(...b(this,V,te).call(this,N,r,I,l(w,j))),l(N,O)["*"]&&s.push(...b(this,V,te).call(this,l(N,O)["*"],r,I,l(w,j)))):(_(N,j,I),h.push(N)))}}a=h.concat(i.shift()??[])}return s.length>1&&s.sort((u,c)=>u.score-c.score),[s.map(({handler:u,params:c})=>[u,c])]}},Q=new WeakMap,O=new WeakMap,oe=new WeakMap,ye=new WeakMap,j=new WeakMap,V=new WeakSet,te=function(r,t,s,n){const a=[];for(let o=0,i=l(r,Q).length;o<i;o++){const d=l(r,Q)[o],u=d[t]||d[T],c={};if(u!==void 0&&(u.params=Object.create(null),a.push(u),s!==ve||n&&n!==ve))for(let f=0,p=u.possibleKeys.length;f<p;f++){const h=u.possibleKeys[f],E=c[u.score];u.params[h]=n!=null&&n[h]&&!E?n[h]:s[h]??(n==null?void 0:n[h]),c[u.score]=!0}}return a},we),ie,tr,ot=(tr=class{constructor(){g(this,"name","TrieRouter");v(this,ie);_(this,ie,new at)}add(e,r,t){const s=ar(r);if(s){for(let n=0,a=s.length;n<a;n++)l(this,ie).insert(e,s[n],t);return}l(this,ie).insert(e,r,t)}match(e,r){return l(this,ie).search(e,r)}},ie=new WeakMap,tr),gr=class extends Kr{constructor(e={}){super(e),this.router=e.router??new nt({routers:[new st,new ot]})}},it=e=>{const t={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},s=(a=>typeof a=="string"?a==="*"?()=>a:o=>a===o?o:null:typeof a=="function"?a:o=>a.includes(o)?o:null)(t.origin),n=(a=>typeof a=="function"?a:Array.isArray(a)?()=>a:()=>[])(t.allowMethods);return async function(o,i){var c;function d(f,p){o.res.headers.set(f,p)}const u=await s(o.req.header("origin")||"",o);if(u&&d("Access-Control-Allow-Origin",u),t.credentials&&d("Access-Control-Allow-Credentials","true"),(c=t.exposeHeaders)!=null&&c.length&&d("Access-Control-Expose-Headers",t.exposeHeaders.join(",")),o.req.method==="OPTIONS"){t.origin!=="*"&&d("Vary","Origin"),t.maxAge!=null&&d("Access-Control-Max-Age",t.maxAge.toString());const f=await n(o.req.header("origin")||"",o);f.length&&d("Access-Control-Allow-Methods",f.join(","));let p=t.allowHeaders;if(!(p!=null&&p.length)){const h=o.req.header("Access-Control-Request-Headers");h&&(p=h.split(/\s*,\s*/))}return p!=null&&p.length&&(d("Access-Control-Allow-Headers",p.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await i(),t.origin!=="*"&&o.header("Vary","Origin",{append:!0})}},dt=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,Je=(e,r=ct)=>{const t=/\.([a-zA-Z0-9]+?)$/,s=e.match(t);if(!s)return;let n=r[s[1]];return n&&n.startsWith("text")&&(n+="; charset=utf-8"),n},ut={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},ct=ut,lt=(...e)=>{let r=e.filter(n=>n!=="").join("/");r=r.replace(new RegExp("(?<=\\/)\\/+","g"),"");const t=r.split("/"),s=[];for(const n of t)n===".."&&s.length>0&&s.at(-1)!==".."?s.pop():n!=="."&&s.push(n);return s.join("/")||"."},yr={br:".br",zstd:".zst",gzip:".gz"},pt=Object.keys(yr),mt="index.html",ft=e=>{const r=e.root??"./",t=e.path,s=e.join??lt;return async(n,a)=>{var c,f,p,h;if(n.finalized)return a();let o;if(e.path)o=e.path;else try{if(o=decodeURIComponent(n.req.path),/(?:^|[\/\\])\.\.(?:$|[\/\\])/.test(o))throw new Error}catch{return await((c=e.onNotFound)==null?void 0:c.call(e,n.req.path,n)),a()}let i=s(r,!t&&e.rewriteRequestPath?e.rewriteRequestPath(o):o);e.isDir&&await e.isDir(i)&&(i=s(i,mt));const d=e.getContent;let u=await d(i,n);if(u instanceof Response)return n.newResponse(u.body,u);if(u){const E=e.mimes&&Je(i,e.mimes)||Je(i);if(n.header("Content-Type",E||"application/octet-stream"),e.precompressed&&(!E||dt.test(E))){const y=new Set((f=n.req.header("Accept-Encoding"))==null?void 0:f.split(",").map(w=>w.trim()));for(const w of pt){if(!y.has(w))continue;const R=await d(i+yr[w],n);if(R){u=R,n.header("Content-Encoding",w),n.header("Vary","Accept-Encoding",{append:!0});break}}}return await((p=e.onFound)==null?void 0:p.call(e,i,n)),n.body(u)}await((h=e.onNotFound)==null?void 0:h.call(e,i,n)),await a()}},ht=async(e,r)=>{let t;r&&r.manifest?typeof r.manifest=="string"?t=JSON.parse(r.manifest):t=r.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?t=JSON.parse(__STATIC_CONTENT_MANIFEST):t=__STATIC_CONTENT_MANIFEST;let s;r&&r.namespace?s=r.namespace:s=__STATIC_CONTENT;const n=t[e]||e;if(!n)return null;const a=await s.get(n,{type:"stream"});return a||null},Et=e=>async function(t,s){return ft({...e,getContent:async a=>ht(a,{manifest:e.manifest,namespace:e.namespace?e.namespace:t.env?t.env.__STATIC_CONTENT:void 0})})(t,s)},_t=e=>Et(e);async function gt(e,r,t,s,n){const a={typ:"JWT",alg:"HS256",cty:"twilio-fpa;v=1"},o=Math.floor(Date.now()/1e3),i=o+3600,d={room:n},u={jti:`${r}-${o}`,iss:r,sub:e,exp:i,grants:{identity:s,video:d}},c=U=>{const I=JSON.stringify(U);return btoa(I).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")},f=c(a),p=c(u),h=`${f}.${p}`,E=new TextEncoder,y=E.encode(t),w=await crypto.subtle.importKey("raw",y,{name:"HMAC",hash:"SHA-256"},!1,["sign"]),R=await crypto.subtle.sign("HMAC",w,E.encode(h)),k=new Uint8Array(R);let S=btoa(String.fromCharCode(...k));return S=S.replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,""),`${h}.${S}`}const m=new gr;m.use("/api/*",it());m.use("/static/*",_t({root:"./public"}));async function wr(e,r,t,s,n){try{const a=`${t}/verify-email?token=${r}`,o=await fetch("https://api.resend.com/emails",{method:"POST",headers:{Authorization:`Bearer ${s}`,"Content-Type":"application/json"},body:JSON.stringify({from:`Amebo <${n}>`,to:e,subject:"Verify your Amebo account",html:`
        ...
        `})});if(!o.ok){const i=await o.text();return console.error("[EMAIL] Resend API error:",i),!1}return!0}catch(a){return console.error("[EMAIL] Send error:",a),!1}}m.post("/api/auth/register-email",async e=>{var r;try{const{email:t,password:s}=await e.req.json();if(!t||!s)return e.json({error:"Email and password required"},400);if(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(t))return e.json({error:"Invalid email format"},400);const a=await e.env.DB.prepare(`
      SELECT id, email_verified FROM users WHERE email = ?
    `).bind(t).first();if(a)return a.email_verified===1?e.json({error:"Email already registered. Please login instead."},409):e.json({error:"Email already registered but not verified",message:'This email is already registered but not verified. Please check your email for the verification link, or click "Resend Verification Email" on the login page.',canResend:!0},409);const o=crypto.randomUUID(),i=crypto.randomUUID(),d=new Date(Date.now()+1440*60*1e3),u=await crypto.subtle.digest("SHA-256",new TextEncoder().encode(s)),c=Array.from(new Uint8Array(u)).map(E=>E.toString(16).padStart(2,"0")).join("");await e.env.DB.prepare(`
      INSERT INTO users (
        id, username, email, public_key, email_verified, 
        verification_token, verification_expires, country_code, tokens
      ) VALUES (?, ?, ?, ?, 0, ?, ?, 'NG', 0)
    `).bind(o,t.split("@")[0],t,c,i,d.toISOString()).run();const f=e.env.APP_URL||"http://localhost:3000",p=e.env.RESEND_API_KEY||"",h=e.env.FROM_EMAIL||"onboarding@resend.dev";try{if(p)await wr(t,i,f,p,h),console.log(`[EMAIL] Verification email sent to: ${t}`);else{const E=`${f}/verify-email?token=${i}`;console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"),console.log("[EMAIL] ⚠️  RESEND_API_KEY not configured"),console.log("[EMAIL] 📧 Development mode - Manual verification link:"),console.log(`[EMAIL] 🔗 ${E}`),console.log("[EMAIL] 📋 Copy this link to verify your email in development"),console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")}}catch(E){console.error("[EMAIL] Failed to send verification email:",E)}return console.log(`[AUTH] User registered: ${t} (verification pending)`),e.json({success:!0,userId:o,email:t,message:"Registration successful! Please check your email to verify your account.",verificationRequired:!0,verificationToken:p?void 0:i})}catch(t){return console.error("[AUTH] Registration error:",t),(r=t.message)!=null&&r.includes("UNIQUE constraint")?e.json({error:"Email already registered"},409):e.json({error:"Registration failed",details:t.message||"Unknown error"},500)}});m.get("/api/auth/verify-email/:token",async e=>{try{const r=e.req.param("token"),t=await e.env.DB.prepare(`
    ...
    `).bind(r).first();if(!s)return e.json({error:"Invalid or expired reset token"},400);const n=new Date,a=new Date(s.password_reset_expires);if(n>a)return e.json({error:"Reset token has expired. Please request a new one."},400);const o=await crypto.subtle.digest("SHA-256",new TextEncoder().encode(t)),i=Array.from(new Uint8Array(o)).map(d=>d.toString(16).padStart(2,"0")).join("");return await e.env.DB.prepare(`
      ...
      WHERE id = ?
    `).bind(i,s.id).run(),console.log("[AUTH] Password reset successful for:",s.email),e.json({success:!0,message:"Password reset successfully. You can now login with your new password."})}catch(r){return console.error("[AUTH] Reset password error:",r),e.json({error:"Failed to reset password",message:r.message},500)}});m.post("/api/auth/register",async e=>{var r;try{const{username:t,publicKey:s}=await e.req.json();if(!t||!s)return e.json({error:"Username and public key required"},400);const n=crypto.randomUUID();return await e.env.DB.prepare(`
      INSERT INTO users (id, username, public_key) VALUES (?, ?, ?)
    `).bind(n,t,s).run(),e.json({success:!0,userId:n,username:t,message:"User registered successfully"})}catch(t){return(r=t.message)!=null&&r.includes("UNIQUE constraint failed")?e.json({error:"Username already exists"},409):e.json({error:"Registration failed"},500)}});m.post("/api/auth/login",async e=>{try{const{username:r}=await e.req.json(),t=await e.env.DB.prepare(`
      SELECT id, username, public_key, avatar, created_at FROM users WHERE username = ?
    `).bind(r).first();return t?e.json({success:!0,user:t}):e.json({error:"User not found"},404)}catch{return e.json({error:"Login failed"},500)}});m.get("/api/users/search",async e=>{var r;try{const t=e.req.query("q"),s=e.req.header("X-User-Email");if(!t||t.length<2)return e.json({error:"Search query must be at least 2 characters"},400);let n="";if(s){const o=await e.env.DB.prepare(`
      ...
      LIMIT 20
    `).bind(n,`%${t}%`,`%${t}%`,`%${t}%`).all();return console.log(`[SEARCH] Query: "${t}", Found: ${((r=a.results)==null?void 0:r.length)||0} users`),e.json({success:!0,users:a.results||[]})}catch(t){return console.error("User search error:",t),e.json({error:"Search failed"},500)}});m.get("/api/users/blocked",async e=>{try{const r=e.req.header("X-User-Email");if(!r)return e.json({error:"Email required"},400);const t=await e.env.DB.prepare(`
      SELECT id FROM users WHERE email = ?
    ...
    `).bind(t.id).all();return e.json({success:!0,blockedUsers:s.results||[]})}catch(r){return console.error("Get blocked users error:",r),e.json({error:"Failed to get blocked users"},500)}});m.get("/api/users/:userId",async e=>{try{const r=e.req.param("userId"),t=await e.env.DB.prepare(`
      SELECT 
        id, 
        username, 
        display_name,
      ...
      FROM users 
      WHERE id = ?
    `).bind(r).first();return t?e.json(t):e.json({error:"User not found"},404)}catch{return e.json({error:"Failed to fetch user"},500)}});m.post("/api/users/update-avatar",async e=>{try{const{userId:r,avatar:t}=await e.req.json();return r?(await e.env.DB.prepare(`
      UPDATE users SET avatar = ? WHERE id = ?
    `).bind(t,r).run(),e.json({success:!0,message:"Avatar updated"})):e.json({error:"User ID required"},400)}catch(r){return console.error("Avatar update error:",r),e.json({error:"Failed to update avatar"},500)}});m.post("/api/users/update-username",async e=>{try{const{userId:r,username:t}=await e.req.json();return!r||!t?e.json({error:"User ID and username required"},400):await e.env.DB.prepare(`
      SELECT id FROM users WHERE username = ? AND id != ?
    `).bind(t,r).first()?e.json({error:"Username already taken"},409):(await e.env.DB.prepare(`
      UPDATE users SET username = ? WHERE id = ?
    `).bind(t,r).run(),e.json({success:!0,message:"Username updated"}))}catch(r){return console.error("Username update error:",r),e.json({error:"Failed to update username"},500)}});m.post("/api/users/update-profile",async e=>{try{const{userId:r,displayName:t,bio:s}=await e.req.json();return r?(await e.env.DB.prepare(`
      UPDATE users SET display_name = ?, bio = ? WHERE id = ?
    `).bind(t||null,s||null,r).run(),e.json({success:!0,message:"Profile updated",displayName:t,bio:s})):e.json({error:"User ID required"},400)}catch(r){return console.error("Profile update error:",r),e.json({error:"Failed to update profile"},500)}});m.post("/api/users/update-password",async e=>{try{const{userId:r,email:t,currentPassword:s,newPassword:n}=await e.req.json();if(!r||!s||!n)return e.json({error:"All fields required"},400);const a=await e.env.DB.prepare(`
    ...
    `).bind(o,n).run(),a&&Array.isArray(a))for(const i of a)i!==n&&await e.env.DB.prepare(`
            INSERT INTO room_members (room_id, user_id) VALUES (?, ?)
          `).bind(o,i).run();return e.json({success:!0,roomId:o,roomCode:t,message:"Room created successfully"})}catch(t){return(r=t.message)!=null&&r.includes("UNIQUE constraint failed")?e.json({error:"Room code already exists"},409):e.json({error:"Failed to create room"},500)}});m.post("/api/rooms/join",async e=>{try{const{roomCode:r,userId:t}=await e.req.json();if(!r||!t)return e.json({error:"Room code and user ID required"},400);const s=await e.env.DB.prepare(`
    ...
    `).bind(s.id,t).first()||await e.env.DB.prepare(`
        INSERT INTO room_members (room_id, user_id) VALUES (?, ?)
      `).bind(s.id,t).run(),e.json({success:!0,room:s,message:"Joined room successfully"})):e.json({error:"Room not found"},404)}catch{return e.json({error:"Failed to join room"},500)}});m.get("/api/rooms/user/:userId",async e=>{try{const r=e.req.param("userId"),t=await e.env.DB.prepare(`
    ...
    `).bind(r).all(),s=await Promise.all((t.results||[]).map(async n=>{try{if(n.room_code&&n.room_code.startsWith("dm-")){const o=await e.env.DB.prepare(`
            SELECT 
              CASE 
            ...
            WHERE dmr.room_id = ?
          `).bind(r,n.id).first();if(o&&o.other_user_id){const i=await e.env.DB.prepare(`
              SELECT id, username, display_name, avatar, online_status, last_seen
              FROM users WHERE id = ?
            `).bind(o.other_user_id).first();if(i)return{...n,room_type:"direct",other_user:{id:i.id,username:i.username,display_name:i.display_name,avatar:i.avatar,online_status:i.online_status,last_seen:i.last_seen}}}}}catch(a){console.error(`Error fetching DM info for room ${n.id}:`,a)}return n}));return e.json({success:!0,rooms:s})}catch(r){return console.error("Failed to fetch rooms:",r),e.json({error:"Failed to fetch rooms"},500)}});m.get("/api/rooms/:roomId/members",async e=>{try{const r=e.req.param("roomId"),t=await e.env.DB.prepare(`
      SELECT u.id, u.username, u.public_key, rm.joined_at
      FROM users u
      JOIN room_members rm ON u.id = rm.user_id
      WHERE rm.room_id = ?
      ORDER BY rm.joined_at ASC
    `).bind(r).all();return e.json({success:!0,members:t.results||[]})}catch{return e.json({error:"Failed to fetch members"},500)}});m.post("/api/users/privacy",async e=>{try{const r=e.req.header("X-User-Email"),{is_searchable:t,message_privacy:s,last_seen_privacy:n}=await e.req.json();if(!r)return e.json({error:"User email required"},400);const a=await e.env.DB.prepare(`
      SELECT id FROM users WHERE email = ?
    ...
    `).bind(s,n,n,s).first();if(o){const E=await e.env.DB.prepare(`
        ...
        WHERE r.id = ?
      `).bind(n,o.room_id).first(),y={...E,other_user:E.other_user_id?{id:E.other_user_id,username:E.other_user_username,display_name:E.other_user_display_name,email:E.other_user_email,avatar:E.other_user_avatar,online_status:E.other_user_online_status,last_seen:E.other_user_last_seen}:null};return e.json({success:!0,room:y,isNew:!1})}const i=crypto.randomUUID(),d=crypto.randomUUID(),u=await e.env.DB.prepare(`
      SELECT username, display_name FROM users WHERE id = ?
    `).bind(n).first(),c=(u==null?void 0:u.display_name)||(u==null?void 0:u.username)||"Direct Message",f=`dm-${crypto.randomUUID().slice(0,8)}`;await e.env.DB.prepare(`
      INSERT INTO chat_rooms (id, room_code, room_name, created_by, room_type)
      VALUES (?, ?, ?, ?, 'direct')
    `).bind(i,f,c,s).run(),await e.env.DB.prepare(`
    ...
    `).bind(i,s).run(),await e.env.DB.prepare(`
      INSERT INTO room_members (room_id, user_id) VALUES (?, ?)
    `).bind(i,n).run();const p=await e.env.DB.prepare(`
      SELECT 
        r.*,
        u2.id as other_user_id,
        u2.username as other_user_username,
      ...
      LEFT JOIN users u2 ON u2.id = ?
      WHERE r.id = ?
    `).bind(n,i).first(),h={...p,other_user:p.other_user_id?{id:p.other_user_id,username:p.other_user_username,display_name:p.other_user_display_name,email:p.other_user_email,avatar:p.other_user_avatar,online_status:p.other_user_online_status,last_seen:p.other_user_last_seen}:null};return e.json({success:!0,room:h,isNew:!0,message:"Direct message room created"})}catch(r){return console.error("DM creation error:",r),e.json({error:"Failed to create direct message",details:r.message},500)}});m.get("/api/rooms/shared/:userId/:otherUserId",async e=>{var r;try{const t=e.req.param("userId"),s=e.req.param("otherUserId"),n=await e.env.DB.prepare(`
    ...
    `).bind(t).first();return n&&n.count===0&&(await e.env.DB.prepare(`
      ...
      `).bind(t).run(),console.log(`[ROOM] Deleted empty room: ${t}`)),e.json({success:!0,message:"Left room successfully"})}catch(r){return console.error("[ROOM] Leave error:",r),e.json({error:"Failed to leave room",details:r.message},500)}});m.post("/api/messages/send",async e=>{try{const{roomId:r,senderId:t,encryptedContent:s,iv:n}=await e.req.json();if(!r||!t||!s||!n)return e.json({error:"All fields required"},400);if(!await e.env.DB.prepare(`
      SELECT * FROM room_members WHERE room_id = ? AND user_id = ?
    ...
    `).bind(o,r,t,s,n).run();try{const i=await e.env.DB.prepare(`
      ...
      `).bind(r,t).all(),c=(d==null?void 0:d.room_name)||(d==null?void 0:d.room_code)||"Unknown Room",f=(i==null?void 0:i.username)||"Someone";for(const p of u||[]){const h=crypto.randomUUID();await e.env.DB.prepare(`
          INSERT INTO notifications (id, user_id, type, title, message, data, read)
          VALUES (?, ?, ?, ?, ?, ?, 0)
        `).bind(h,p.user_id,"new_message",`New message in ${c}`,`${f} sent a message`,JSON.stringify({roomId:r,messageId:o,senderId:t,roomName:c})).run(),console.log(`[NOTIFICATION] Created for user ${p.user_id} in room ${c}`)}}catch(i){console.error("[NOTIFICATION] Error creating notifications:",i)}return e.json({success:!0,messageId:o,message:"Message sent successfully"})}catch{return e.json({error:"Failed to send message"},500)}});m.get("/api/messages/:roomId",async e=>{try{const r=e.req.param("roomId"),t=parseInt(e.req.query("limit")||"50"),s=parseInt(e.req.query("offset")||"0"),n=await e.env.DB.prepare(`
  ...
  `));function qe(e){return e>=1e3?{tier:"platinum",multiplier:2}:e>=500?{tier:"gold",multiplier:1.5}:e>=100?{tier:"silver",multiplier:1.2}:{tier:"bronze",multiplier:1}}async function vr(e,r,t){const s=new Date().toISOString().substring(0,7),n=await e.prepare(`
  ...
  `).bind(r,n).first();a||(await e.prepare(`
      ...
      VALUES (?, ?, 0, 0, 0)
    `).bind(r,n).run(),a={messages_count:0,files_count:0,total_earned:0});const o=100,i=60,d=500;return t==="message_sent"&&a.messages_count+s>o?{allowed:!1,reason:"Daily message token limit reached",current:a.messages_count,limit:o}:t==="file_shared"&&a.files_count+s>i?{allowed:!1,reason:"Daily file sharing token limit reached",current:a.files_count,limit:i}:a.total_earned+s>d?{allowed:!1,reason:"Daily total token limit reached",current:a.total_earned,limit:d}:{allowed:!0}}m.post("/api/tokens/award",async e=>{try{const{userId:r,amount:t,reason:s}=await e.req.json();if(!r||!t)return e.json({error:"User ID and amount required"},400);if(t<=0)return e.json({error:"Amount must be greater than 0"},400);const n=await e.env.DB.prepare(`
      SELECT tokens, token_tier, total_earned FROM users WHERE id = ?
    `).bind(r).first();if(!n)return e.json({error:"User not found"},404);const a=n.tokens||0,{tier:o,multiplier:i}=qe(a),d=await vr(e.env.DB,r,t);if(!d.allowed)return console.log(`[TOKEN ECONOMY] ❌ Monthly limit reached for ${r}: ${d.reason}`),e.json({error:d.reason,monthlyLimitReached:!0,current:d.current,limit:d.limit,remaining:d.remaining},429);const u=["message_sent","file_shared","message","file_share"];if(u.includes(s)){const y=await yt(e.env.DB,r,s,t);if(!y.allowed)return console.log(`[TOKEN ECONOMY] ⚠️ Daily limit reached for ${r}: ${y.reason}`),e.json({error:y.reason,dailyLimitReached:!0,current:y.current,limit:y.limit},429)}const c=Math.floor(t*i),f=a+c,p=qe(f).tier;if(await e.env.DB.prepare(`
      UPDATE users 
      SET tokens = tokens + ?, 
          token_tier = ?,
          total_earned = total_earned + ?
      WHERE id = ?
    `).bind(c,p,c,r).run(),await e.env.DB.prepare(`
      INSERT INTO token_earnings (user_id, action, amount, tier, daily_total)
      VALUES (?, ?, ?, ?, ?)
    `).bind(r,s,c,o,c).run(),u.includes(s)){const y=new Date().toISOString().split("T")[0],w=s==="message_sent"||s==="message"?"messages_count":"files_count";await e.env.DB.prepare(`
        UPDATE daily_earning_caps 
        SET ${w} = ${w} + ?,
            total_earned = total_earned + ?
        WHERE user_id = ? AND date = ?
      `).bind(c,c,r,y).run()}await br(e.env.DB,r,c,s);const h=i>1?` (${o} tier ${i}x bonus!)`:"",E=d.isWarning?` ⚠️ Approaching monthly limit (${d.current+c}/${d.limit})`:"";return console.log(`[TOKEN ECONOMY] User ${r} earned ${c} tokens for ${s}${h}. New balance: ${f}${E}`),e.json({success:!0,newBalance:f,amount:c,baseAmount:t,multiplier:i,tier:p,tierBonus:i>1,reason:s,monthlyLimit:d.limit,monthlyEarned:d.current+c,monthlyRemaining:d.remaining,monthlyWarning:d.isWarning,monthlyPercentage:Math.floor((d.current+c)/d.limit*100)})}catch(r){return console.error("Award tokens error:",r),e.json({error:"Failed to award tokens"},500)}});m.get("/api/tokens/balance/:userId",async e=>{try{const r=e.req.param("userId"),t=await e.env.DB.prepare(`
    ...
    `).all(),n={};s.results.forEach(h=>{n[h.cap_name]=h.cap_value});const a=n.monthly_total_cap||1500,o=n.warning_threshold||1400,i=await e.env.DB.prepare(`
      SELECT * FROM monthly_earning_caps WHERE user_id = ? AND year_month = ?
    `).bind(r,t).first(),d=(i==null?void 0:i.total_earned)||0,u=a-d,c=Math.floor(d/a*100);let f="normal";d>=a?f="capped":d>=o&&(f="warning");const p=await e.env.DB.prepare(`
      SELECT action, tokens_earned, tokens_total, created_at
      FROM monthly_cap_history
      WHERE user_id = ? AND year_month = ?
      ORDER BY created_at DESC
      LIMIT 20
    `).bind(r,t).all();return e.json({success:!0,data:{yearMonth:t,earned:d,limit:a,remaining:u>0?u:0,percentage:c,status:f,warningThreshold:o,breakdown:{messages:(i==null?void 0:i.messages_count)||0,files:(i==null?void 0:i.files_count)||0,roomsCreated:(i==null?void 0:i.rooms_created_count)||0,roomsJoined:(i==null?void 0:i.rooms_joined_count)||0},history:p.results||[]}})}catch(r){return console.error("Get monthly stats error:",r),e.json({error:"Failed to get monthly stats"},500)}});m.post("/api/tokens/bonus/award",async e=>{try{const{userId:r,bonusType:t}=await e.req.json();if(!r||!t)return e.json({error:"User ID and bonus type required"},400);const s=new Date().toISOString().substring(0,7);if(await e.env.DB.prepare(`
    ...
    `).bind(`bonus_${t}`).first();if(!a)return e.json({error:"Invalid bonus type"},400);const o=a.cap_value,i=await vr(e.env.DB,r,o);if(!i.allowed)return e.json({error:`Cannot award bonus - monthly limit reached (${i.current}/${i.limit})`,monthlyLimitReached:!0,current:i.current,limit:i.limit},429);const d=await e.env.DB.prepare(`
    ...
    `).bind(o,o,r).run(),await e.env.DB.prepare(`
      ...
      VALUES (?, ?, ?, ?)
    `).bind(r,s,t,o).run(),await br(e.env.DB,r,o,`bonus_${t}`);const u=(d.tokens||0)+o;return console.log(`[BONUS] User ${r} earned ${o} bonus tokens for ${t}. New balance: ${u}`),e.json({success:!0,bonusType:t,bonusAmount:o,newBalance:u,message:`🎉 +${o} bonus tokens!`,monthlyEarned:i.current+o,monthlyLimit:i.limit,monthlyRemaining:i.remaining})}catch(r){return console.error("Award bonus error:",r),e.json({error:"Failed to award bonus"},500)}});m.get("/api/tokens/bonus/:userId",async e=>{try{const r=e.req.param("userId"),t=new Date().toISOString().substring(0,7),s=await e.env.DB.prepare(`
    ...
    `).all(),i=s.results.map(h=>h.bonus_type),d=o.results.filter(h=>{const E=h.cap_name.replace("bonus_","");return!i.includes(E)}).map(h=>({type:h.cap_name.replace("bonus_",""),amount:h.cap_value,description:h.description})),u=await e.env.DB.prepare(`
      SELECT cap_value FROM monthly_cap_config WHERE cap_name = 'monthly_total_cap' AND is_active = 1
    `).first(),c=(u==null?void 0:u.cap_value)||1500,f=await e.env.DB.prepare(`
      SELECT total_earned FROM monthly_earning_caps WHERE user_id = ? AND year_month = ?
    `).bind(r,t).first(),p=(f==null?void 0:f.total_earned)||0;return e.json({success:!0,data:{monthlyLimit:c,monthlyEarned:p,monthlyRemaining:c-p,totalBonusTokensEarned:a,earned:s.results||[],available:d,note:"Bonuses award instant tokens that count toward the 1500 monthly limit"}})}catch(r){return console.error("Get bonuses error:",r),e.json({error:"Failed to get bonuses"},500)}});m.post("/api/users/pin/set",async e=>{try{const{userId:r,pin:t}=await e.req.json();if(!r||!t)return e.json({error:"User ID and PIN required"},400);if(t.length!==4||!/^\d{4}$/.test(t))return e.json({error:"PIN must be exactly 4 digits"},400);const s=await crypto.subtle.digest("SHA-256",new TextEncoder().encode(t)),n=Array.from(new Uint8Array(s)).map(a=>a.toString(16).padStart(2,"0")).join("");return await e.env.DB.prepare(`
      UPDATE users SET pin = ? WHERE id = ?
    `).bind(n,r).run(),e.json({success:!0,message:"PIN set successfully"})}catch(r){return console.error("Set PIN error:",r),e.json({error:"Failed to set PIN"},500)}});m.post("/api/users/pin/verify",async e=>{try{const{userId:r,pin:t}=await e.req.json();if(!r||!t)return e.json({error:"User ID and PIN required"},400);const s=await crypto.subtle.digest("SHA-256",new TextEncoder().encode(t)),n=Array.from(new Uint8Array(s)).map(i=>i.toString(16).padStart(2,"0")).join(""),a=await e.env.DB.prepare(`
      SELECT pin FROM users WHERE id = ?
    `).bind(r).first();if(!a||!a.pin)return e.json({verified:!1,error:"No PIN set"},400);const o=a.pin===n;return e.json({verified:o})}catch(r){return console.error("Verify PIN error:",r),e.json({error:"Failed to verify PIN"},500)}});m.get("/api/users/:userId/has-pin",async e=>{try{const r=e.req.param("userId"),t=await e.env.DB.prepare(`
      SELECT pin FROM users WHERE id = ?
    `).bind(r).first();return e.json({hasPin:!!(t&&t.pin)})}catch(r){return console.error("Check PIN error:",r),e.json({error:"Failed to check PIN"},500)}});m.post("/api/users/pin/security-question",async e=>{try{const{userId:r,question:t,answer:s}=await e.req.json();if(!r||!t||!s)return e.json({error:"User ID, question, and answer required"},400);if(s.trim().length<3)return e.json({error:"Answer must be at least 3 characters"},400);const n=await crypto.subtle.digest("SHA-256",new TextEncoder().encode(s.toLowerCase().trim())),a=Array.from(new Uint8Array(n)).map(o=>o.toString(16).padStart(2,"0")).join("");return await e.env.DB.prepare(`
      UPDATE users 
      SET security_question = ?, security_answer = ?
      WHERE id = ?
    `).bind(t,a,r).run(),console.log(`[SECURITY] User ${r} set security question`),e.json({success:!0,message:"Security question set successfully"})}catch(r){return console.error("Set security question error:",r),e.json({error:"Failed to set security question"},500)}});m.get("/api/users/:userId/security-question",async e=>{try{const r=e.req.param("userId"),t=await e.env.DB.prepare(`
      SELECT security_question FROM users WHERE id = ?
    `).bind(r).first();return!t||!t.security_question?e.json({error:"No security question set"},404):e.json({success:!0,question:t.security_question})}catch(r){return console.error("Get security question error:",r),e.json({error:"Failed to get security question"},500)}});m.post("/api/users/pin/reset",async e=>{try{const{userId:r,answer:t,newPin:s}=await e.req.json();if(!r||!t||!s)return e.json({error:"User ID, answer, and new PIN required"},400);if(s.length!==4||!/^\d{4}$/.test(s))return e.json({error:"PIN must be exactly 4 digits"},400);const n=await e.env.DB.prepare(`
      SELECT security_answer, pin_reset_attempts, last_pin_reset FROM users WHERE id = ?
    `).bind(r).first();if(!n||!n.security_answer)return e.json({error:"No security question set"},404);const a=new Date;if(n.last_pin_reset){const c=new Date(n.last_pin_reset),f=(a.getTime()-c.getTime())/(1e3*60*60);if(f<1&&n.pin_reset_attempts>=5)return e.json({error:"Too many reset attempts. Please try again in 1 hour.",remainingTime:Math.ceil((1-f)*60)},429);f>=1&&await e.env.DB.prepare(`
        ...
        SET pin_reset_attempts = pin_reset_attempts + 1,
            last_pin_reset = ?
        WHERE id = ?
      `).bind(a.toISOString(),r).run();const c=(n.pin_reset_attempts||0)+1,f=5-c;return console.log(`[PIN RESET] Failed attempt for user ${r}. Attempts: ${c}/5`),e.json({error:"Incorrect answer",verified:!1,remainingAttempts:Math.max(0,f)},400)}const d=await crypto.subtle.digest("SHA-256",new TextEncoder().encode(s)),u=Array.from(new Uint8Array(d)).map(c=>c.toString(16).padStart(2,"0")).join("");return await e.env.DB.prepare(`
      UPDATE users 
      SET pin = ?, 
          pin_reset_attempts = 0,
          last_pin_reset = ?
      WHERE id = ?
    `).bind(u,a.toISOString(),r).run(),console.log(`[PIN RESET] User ${r} successfully reset PIN`),e.json({success:!0,verified:!0,message:"PIN reset successfully"})}catch(r){return console.error("Reset PIN error:",r),e.json({error:"Failed to reset PIN"},500)}});m.post("/api/tokens/gift",async e=>{try{const{fromUserId:r,toUserId:t,amount:s,roomId:n,message:a,pin:o}=await e.req.json();if(!r||!t||!s||!o)return e.json({error:"From user, to user, amount, and PIN required"},400);if(s<=0)return e.json({error:"Amount must be greater than 0"},400);if(r===t)return e.json({error:"Cannot send tokens to yourself"},400);const i=new Date,d=new Date(i.getFullYear(),0,1),u=Math.floor((i.getTime()-d.getTime())/(1440*60*1e3)),c=Math.ceil((u+d.getDay()+1)/7),f=`${i.getFullYear()}-${String(c).padStart(2,"0")}`,p=await e.env.DB.prepare(`
      SELECT config_value FROM weekly_gift_config WHERE config_name = 'weekly_gift_limit' AND is_active = 1
    `).bind().first(),h=(p==null?void 0:p.config_value)||150;let E=await e.env.DB.prepare(`
      SELECT * FROM weekly_gift_tracking WHERE user_id = ? AND year_week = ?
    `).bind(r,f).first();E||(await e.env.DB.prepare(`
        INSERT INTO weekly_gift_tracking (user_id, year_week, total_gifted, gift_count)
        VALUES (?, ?, 0, 0)
      `).bind(r,f).run(),E={user_id:r,year_week:f,total_gifted:0,gift_count:0});const y=E.total_gifted||0,w=h-y;if(y+s>h)return console.log(`[WEEKLY GIFT LIMIT] User ${r} exceeded weekly limit. Current: ${y}, Attempting: ${s}, Limit: ${h}`),await e.env.DB.prepare(`
        INSERT INTO weekly_gift_history (user_id, year_week, amount, recipient_id, total_gifted_after, limit_value, exceeded)
        VALUES (?, ?, ?, ?, ?, ?, 1)
      `).bind(r,f,s,t,y,h).run(),e.json({error:`Weekly gift limit reached! You can only gift ${h} tokens per week. You have gifted ${y} tokens this week. Remaining: ${w} tokens`,weeklyLimit:h,weeklyGifted:y,weeklyRemaining:w,limitExceeded:!0},400);const R=await crypto.subtle.digest("SHA-256",new TextEncoder().encode(o)),k=Array.from(new Uint8Array(R)).map(Ir=>Ir.toString(16).padStart(2,"0")).join(""),S=await e.env.DB.prepare(`
      SELECT pin, tokens, username FROM users WHERE id = ?
    `).bind(r).first();if(!S)return e.json({error:"User not found"},404);if(!S.pin)return e.json({error:"Please set a PIN first"},400);if(S.pin!==k)return e.json({error:"Invalid PIN"},401);const U=S.tokens||0;if(U<s)return e.json({error:`Insufficient tokens. You have ${U} tokens`},400);const I=await e.env.DB.prepare(`
      SELECT username, tokens FROM users WHERE id = ?
    `).bind(t).first();if(!I)return e.json({error:"Recipient not found"},404);console.log(`[TOKEN GIFT] ${S.username} sending ${s} tokens to ${I.username} (Weekly: ${y+s}/${h})`);const Z=await e.env.DB.prepare(`
    ...
    `).bind(L,r,t,s,n||null,a||null).run(),console.log(`[TOKEN GIFT] Transaction recorded: ${L}`);const N=crypto.randomUUID();await e.env.DB.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?)
    `).bind(N,t,"token_gift","🎁 Token Gift Received!",`${S.username} sent you ${s} tokens${a?": "+a:""}`,JSON.stringify({fromUserId:r,amount:s,message:a,transactionId:L})).run(),console.log("[TOKEN GIFT] Notification created for receiver");const x=y+s;await e.env.DB.prepare(`
    ...
    `).bind(x,r,f).run(),console.log(`[WEEKLY GIFT TRACKING] Updated: ${x}/${h} tokens gifted this week`),await e.env.DB.prepare(`
      INSERT INTO weekly_gift_history (user_id, year_week, amount, recipient_id, total_gifted_after, limit_value, exceeded)
      VALUES (?, ?, ?, ?, ?, ?, 0)
    `).bind(r,f,s,t,x,h).run();const A=U-s,H=(I.tokens||0)+s,ue=h-x;let Pe="";return ue<=30&&ue>0?Pe=` ⚠️ Only ${ue} tokens remaining this week!`:ue===0&&(Pe=" 🚫 Weekly gift limit reached!"),e.json({success:!0,message:`Successfully sent ${s} tokens to ${I.username}${Pe}`,transactionId:L,newBalance:A,receiverUsername:I.username,receiverBalance:H,fromUsername:S.username,weeklyGifted:x,weeklyLimit:h,weeklyRemaining:ue})}catch(r){return console.error("Gift tokens error:",r),e.json({error:"Failed to gift tokens",details:r.message},500)}});m.get("/api/tokens/weekly-gift-status/:userId",async e=>{try{const r=e.req.param("userId"),t=new Date,s=new Date(t.getFullYear(),0,1),n=Math.floor((t.getTime()-s.getTime())/(1440*60*1e3)),a=Math.ceil((n+s.getDay()+1)/7),o=`${t.getFullYear()}-${String(a).padStart(2,"0")}`,i=await e.env.DB.prepare(`
      SELECT config_value FROM weekly_gift_config WHERE config_name = 'weekly_gift_limit' AND is_active = 1
    `).bind().first(),d=(i==null?void 0:i.config_value)||150,u=await e.env.DB.prepare(`
      SELECT * FROM weekly_gift_tracking WHERE user_id = ? AND year_week = ?
    `).bind(r,o).first(),c=(u==null?void 0:u.total_gifted)||0,f=(u==null?void 0:u.gift_count)||0,p=d-c;return e.json({success:!0,yearWeek:o,weeklyLimit:d,totalGifted:c,remaining:p,giftCount:f,lastGiftAt:(u==null?void 0:u.last_gift_at)||null,limitReached:c>=d,percentageUsed:Math.round(c/d*100)})}catch(r){return console.error("Get weekly gift status error:",r),e.json({error:"Failed to get weekly gift status"},500)}});m.get("/api/tokens/history/:userId",async e=>{try{const r=e.req.param("userId"),{results:t}=await e.env.DB.prepare(`
      SELECT 
        t.*,
      ...
      LIMIT 50
    `).bind(r,r).all();return e.json({success:!0,transactions:t||[]})}catch(r){return console.error("Get token history error:",r),e.json({error:"Failed to get token history"},500)}});m.get("/api/rooms/:roomId/members",async e=>{try{const r=e.req.param("roomId"),{results:t}=await e.env.DB.prepare(`
      SELECT DISTINCT u.id, u.username
      FROM messages m
      JOIN users u ON m.sender_id = u.id
      WHERE m.room_id = ?
      ORDER BY u.username
    `).bind(r).all();return e.json({success:!0,members:t||[]})}catch(r){return console.error("Get room members error:",r),e.json({error:"Failed to get room members"},500)}});m.get("/api/notifications/:userId",async e=>{try{const r=e.req.param("userId"),{results:t}=await e.env.DB.prepare(`
      SELECT * FROM notifications
      WHERE user_id = ?
      ORDER BY created_at DESC
      LIMIT 20
    `).bind(r).all();return e.json({success:!0,notifications:t||[]})}catch(r){return console.error("Get notifications error:",r),e.json({error:"Failed to get notifications"},500)}});m.post("/api/notifications/:notificationId/read",async e=>{try{const r=e.req.param("notificationId");return await e.env.DB.prepare(`
      UPDATE notifications SET read = 1 WHERE id = ?
    `).bind(r).run(),e.json({success:!0})}catch(r){return console.error("Mark notification read error:",r),e.json({error:"Failed to mark notification as read"},500)}});m.get("/api/notifications/:userId/unread-count",async e=>{try{const r=e.req.param("userId"),t=await e.env.DB.prepare(`
      SELECT COUNT(*) as count FROM notifications
      WHERE user_id = ? AND read = 0
    `).bind(r).first();return e.json({success:!0,count:(t==null?void 0:t.count)||0})}catch(r){return console.error("Get unread count error:",r),e.json({error:"Failed to get unread count"},500)}});m.get("/api/notifications/:userId/unread",async e=>{try{const r=e.req.param("userId"),{results:t}=await e.env.DB.prepare(`
      SELECT * FROM notifications
      WHERE user_id = ? AND read = 0
      ORDER BY created_at DESC
      LIMIT 10
    `).bind(r).all();return e.json({success:!0,notifications:t||[]})}catch(r){return console.error("Get unread notifications error:",r),e.json({error:"Failed to get unread notifications"},500)}});m.get("/api/data/plans",async e=>{try{const r=e.req.query("network");let t="SELECT * FROM data_plans WHERE active = 1";const s=[];r&&(t+=" AND network = ?",s.push(r)),t+=" ORDER BY token_cost ASC";const n=await e.env.DB.prepare(t).bind(...s).all();return e.json({success:!0,data:n.results||[]})}catch(r){return console.error("Get data plans error:",r),e.json({error:"Failed to get data plans"},500)}});m.post("/api/data/redeem",async e=>{var r,t,s,n,a,o,i;try{const{userId:d,planCode:u,phoneNumber:c}=await e.req.json();if(!d||!u||!c)return e.json({error:"User ID, plan code, and phone number required"},400);if(!/^0[789][01]\d{8}$/.test(c))return e.json({error:"Invalid Nigerian phone number format"},400);const p=await e.env.DB.prepare(`
      SELECT * FROM data_plans WHERE plan_code = ? AND active = 1
    `).bind(u).first();if(!p)return e.json({error:"Data plan not found"},404);const h=await e.env.DB.prepare(`
      SELECT tokens, email, phone_number FROM users WHERE id = ?
    `).bind(d).first();if(!h)return e.json({error:"User not found"},404);if(h.tokens<p.token_cost)return e.json({error:"Insufficient tokens",required:p.token_cost,current:h.tokens},400);const E=crypto.randomUUID();await e.env.DB.prepare(`
      INSERT INTO data_redemptions (
        user_id, phone_number, network, data_plan, 
        data_amount, token_cost, status, transaction_id
      ) VALUES (?, ?, ?, ?, ?, ?, 'pending', ?)
    `).bind(d,c,p.network,p.plan_code,p.data_amount,p.token_cost,E).run(),await e.env.DB.prepare(`
      UPDATE users 
      SET tokens = tokens - ?,
          total_spent = total_spent + ?
      WHERE id = ?
    `).bind(p.token_cost,p.token_cost,d).run();let y="pending",w=null,R=null;const k=e.env.VTPASS_API_KEY,S=e.env.VTPASS_PUBLIC_KEY,U=e.env.VTPASS_SECRET_KEY,I=e.env.VTPASS_BASE_URL||"https://sandbox.vtpass.com/api";if(k&&S&&U)try{const L={MTN:"mtn-data",Airtel:"airtel-data",Glo:"glo-data","9mobile":"etisalat-data"}[p.network]||"mtn-data",N=`SCPAY-${Date.now()}-${Math.floor(Math.random()*1e4)}`;console.log(`[VTPASS] Purchasing ${p.data_amount} ${p.network} data for ${c}`);const x=await fetch(`${I}/pay`,{method:"POST",headers:{"api-key":k,"secret-key":U,"Content-Type":"application/json"},body:JSON.stringify({request_id:N,serviceID:L,billersCode:c,variation_code:p.plan_code,amount:parseInt(p.variation_amount||"0"),phone:c})});if(!x.ok)throw new Error(`VTPass API error: ${x.status} ${x.statusText}`);const A=await x.json();console.log(`[VTPASS] Response code: ${A.code}, status: ${(t=(r=A.content)==null?void 0:r.transactions)==null?void 0:t.status}`);const H=(a=(n=(s=A.content)==null?void 0:s.transactions)==null?void 0:n.status)==null?void 0:a.toLowerCase();H==="delivered"||H==="successful"?y="completed":H==="failed"||H==="reversed"?(y="failed",R=A.response_description||"Transaction failed"):y="pending",w=((i=(o=A.content)==null?void 0:o.transactions)==null?void 0:i.transactionId)||N,console.log(`[VTPASS] Transaction ${E} status: ${y}`)}catch(ee){console.error("[VTPASS] API error:",ee),y="failed",R=ee.message||"VTPass API error",await e.env.DB.prepare(`
          UPDATE users 
          SET tokens = tokens + ?,
              total_spent = total_spent - ?
          WHERE id = ?
        `).bind(p.token_cost,p.token_cost,d).run(),console.log(`[VTPASS] Refunded ${p.token_cost} tokens to user ${d} due to API error`)}else console.log("[DATA REDEMPTION] DEMO MODE - VTPass API keys not configured"),y="completed",w="DEMO-"+Date.now();await e.env.DB.prepare(`
    ...
    `).bind(y,w,R,y!=="pending"?new Date().toISOString():null,E).run(),console.log(`[DATA REDEMPTION] User ${d} redeemed ${p.data_amount} ${p.network} data for ${p.token_cost} tokens`),await e.env.DB.prepare(`
      INSERT INTO notifications (user_id, type, title, message)
      VALUES (?, 'data_redeemed', 'Data Redeemed!', ?)
    `).bind(d,`${p.data_amount} ${p.network} data sent to ${c}`).run();const Z=await e.env.DB.prepare(`
      SELECT tokens FROM users WHERE id = ?
    `).bind(d).first();return e.json({success:!0,transactionId:E,message:`${p.data_amount} data will be sent to ${c} shortly`,newBalance:(Z==null?void 0:Z.tokens)||0,redemption:{network:p.network,dataAmount:p.data_amount,phoneNumber:c,status:y}})}catch(d){return console.error("Data redemption error:",d),e.json({error:"Failed to redeem data"},500)}});m.get("/api/data/history/:userId",async e=>{try{const r=e.req.param("userId"),t=parseInt(e.req.query("limit")||"20"),s=await e.env.DB.prepare(`
      SELECT 
      ...
      ORDER BY created_at DESC
      LIMIT ?
    `).bind(r,t).all();return e.json({success:!0,history:s.results||[]})}catch(r){return console.error("Get redemption history error:",r),e.json({error:"Failed to get history"},500)}});m.get("/api/data/status/:transactionId",async e=>{try{const r=e.req.param("transactionId"),t=await e.env.DB.prepare(`
      SELECT * FROM data_redemptions WHERE transaction_id = ?
    `).bind(r).first();return t?e.json({success:!0,status:t.status,details:t}):e.json({error:"Transaction not found"},404)}catch(r){return console.error("Get redemption status error:",r),e.json({error:"Failed to get status"},500)}});m.post("/api/ads/register-advertiser",async e=>{try{const{businessName:r,email:t,phone:s,instagramHandle:n,websiteUrl:a}=await e.req.json();if(!r||!t)return e.json({error:"Business name and email required"},400);if(await e.env.DB.prepare(`
    ...
    `).bind(t,r).run(),console.log(`[ADS] Campaign ${t}: ${r}`),e.json({success:!0,campaignId:r,status:t,message:`Campaign ${t==="active"?"resumed":"paused"} successfully!`})):e.json({error:"Campaign not found"},404):e.json({error:'Invalid status. Use "active" or "paused"'},400)}catch(r){return console.error("[ADS] Campaign status update error:",r),e.json({error:"Status update failed"},500)}});m.get("/api/ads/campaign/:campaignId",async e=>{try{const r=e.req.param("campaignId"),t=await e.env.DB.prepare(`
      ...
      FROM ad_campaigns
      WHERE id = ?
    `).bind(r).first();return t?e.json({success:!0,campaign:t}):e.json({error:"Campaign not found"},404)}catch(r){return console.error("[ADS] Get campaign error:",r),e.json({error:"Failed to fetch campaign"},500)}});m.get("/api/ads/active",async e=>{try{const r=e.req.query("userId"),t=await e.env.DB.prepare(`
      SELECT 
      ...
      ORDER BY RANDOM()
      LIMIT 1
    `).first();return t?e.json({success:!0,ad:t}):e.json({success:!0,ad:null,message:"No active ads"})}catch(r){return console.error("[ADS] Get active ads error:",r),e.json({error:"Failed to get ads"},500)}});m.post("/api/ads/impression",async e=>{try{const{campaignId:r,userId:t,sessionId:s}=await e.req.json();if(!r)return e.json({error:"Campaign ID required"},400);const n=await e.env.DB.prepare(`
    ...
    `).bind(n.id,t).run(),await e.env.DB.prepare(`
      DELETE FROM user_contacts WHERE user_id = ? AND contact_user_id = ?
    `).bind(t,n.id).run(),console.log(`[BLOCK] User ${n.id} blocked ${t}`),e.json({success:!0,message:"User blocked"})):e.json({error:"User not found"},404)}catch(r){return console.error("[BLOCK] Block error:",r),e.json({error:"Failed to block user"},500)}});m.delete("/api/users/block/:userId",async e=>{try{const r=e.req.header("X-User-Email"),t=e.req.param("userId");if(!r||!t)return e.json({error:"User email and blocked user ID required"},400);const s=await e.env.DB.prepare("SELECT id FROM users WHERE email = ?").bind(r).first();return s?(await e.env.DB.prepare(`
      DELETE FROM blocked_users WHERE user_id = ? AND blocked_user_id = ?
    `).bind(s.id,t).run(),console.log(`[BLOCK] User ${s.id} unblocked ${t}`),e.json({success:!0,message:"User unblocked"})):e.json({error:"User not found"},404)}catch(r){return console.error("[BLOCK] Unblock error:",r),e.json({error:"Failed to unblock user"},500)}});m.post("/api/users/status",async e=>{try{const r=e.req.header("X-User-Email"),{status:t}=await e.req.json();if(!r||!t)return e.json({error:"User email and status required"},400);const s=await e.env.DB.prepare("SELECT id FROM users WHERE email = ?").bind(r).first();return s?(await e.env.DB.prepare(`
      UPDATE users 
      SET online_status = ?, last_seen = datetime('now')
      WHERE id = ?
    `).bind(t,s.id).run(),e.json({success:!0})):e.json({error:"User not found"},404)}catch(r){return console.error("[STATUS] Update error:",r),e.json({error:"Failed to update status"},500)}});m.get("/api/rooms/:roomId/online",async e=>{try{const r=e.req.param("roomId"),t=await e.env.DB.prepare(`
      ...
      ORDER BY u.username
    `).bind(r).all();return e.json({online:t.results||[]})}catch(r){return console.error("[STATUS] Get online error:",r),e.json({error:"Failed to get online users"},500)}});m.post("/api/typing/start",async e=>{try{const r=e.req.header("X-User-Email"),{room_id:t}=await e.req.json();if(!r||!t)return e.json({error:"User email and room ID required"},400);const s=await e.env.DB.prepare("SELECT id FROM users WHERE email = ?").bind(r).first();return s?(await e.env.DB.prepare(`
      INSERT OR REPLACE INTO typing_status (room_id, user_id, started_at)
      VALUES (?, ?, datetime('now'))
    `).bind(t,s.id).run(),e.json({success:!0})):e.json({error:"User not found"},404)}catch(r){return console.error("[TYPING] Start error:",r),e.json({error:"Failed to start typing"},500)}});m.post("/api/typing/stop",async e=>{try{const r=e.req.header("X-User-Email"),{room_id:t}=await e.req.json();if(!r||!t)return e.json({error:"User email and room ID required"},400);const s=await e.env.DB.prepare("SELECT id FROM users WHERE email = ?").bind(r).first();return s?(await e.env.DB.prepare(`
      DELETE FROM typing_status WHERE room_id = ? AND user_id = ?
    `).bind(t,s.id).run(),e.json({success:!0})):e.json({error:"User not found"},404)}catch(r){return console.error("[TYPING] Stop error:",r),e.json({error:"Failed to stop typing"},500)}});m.get("/api/typing/:roomId",async e=>{try{const r=e.req.param("roomId"),t=await e.env.DB.prepare(`
      SELECT u.id, u.username, u.avatar
      FROM typing_status ts
      JOIN users u ON ts.user_id = u.id
      WHERE ts.room_id = ? AND ts.started_at >= datetime('now', '-5 seconds')
    `).bind(r).all();return e.json({typing:t.results||[]})}catch(r){return console.error("[TYPING] Get error:",r),e.json({error:"Failed to get typing users"},500)}});m.post("/api/messages/:messageId/read",async e=>{try{const r=e.req.header("X-User-Email"),t=e.req.param("messageId");if(!r||!t)return e.json({error:"User email and message ID required"},400);const s=await e.env.DB.prepare("SELECT id FROM users WHERE email = ?").bind(r).first();return s?(await e.env.DB.prepare(`
      INSERT OR REPLACE INTO message_receipts (message_id, user_id, read_at)
      VALUES (?, ?, datetime('now'))
    `).bind(t,s.id).run(),e.json({success:!0})):e.json({error:"User not found"},404)}catch(r){return console.error("[RECEIPTS] Mark read error:",r),e.json({error:"Failed to mark message as read"},500)}});m.get("/api/messages/:messageId/receipts",async e=>{try{const r=e.req.param("messageId"),t=await e.env.DB.prepare(`
      SELECT u.id, u.username, u.avatar, mr.read_at
      FROM message_receipts mr
      JOIN users u ON mr.user_id = u.id
      WHERE mr.message_id = ?
      ORDER BY mr.read_at ASC
    `).bind(r).all();return e.json({receipts:t.results||[]})}catch(r){return console.error("[RECEIPTS] Get receipts error:",r),e.json({error:"Failed to get read receipts"},500)}});m.post("/api/profile/nickname",async e=>{try{const{userId:r,targetUserId:t,roomId:s,nickname:n}=await e.req.json();if(!r||!n)return e.json({error:"User ID and nickname required"},400);const a=crypto.randomUUID();return await e.env.DB.prepare(`
    ...
    `).bind(a,r,t||null,s||null,n,n).run(),e.json({success:!0,nickname:n})}catch(r){return console.error("[PROFILE] Set nickname error:",r),e.json({error:"Failed to set nickname"},500)}});m.get("/api/profile/nickname/:userId/:targetUserId",async e=>{try{const r=e.req.param("userId"),t=e.req.param("targetUserId"),s=await e.env.DB.prepare(`
      SELECT nickname FROM custom_nicknames 
      WHERE user_id = ? AND target_user_id = ?
    `).bind(r,t).first();return e.json({nickname:(s==null?void 0:s.nickname)||null})}catch(r){return console.error("[PROFILE] Get nickname error:",r),e.json({error:"Failed to get nickname"},500)}});m.post("/api/profile/mute",async e=>{try{const{userId:r,roomId:t,duration:s}=await e.req.json();if(!r||!t)return e.json({error:"User ID and room ID required"},400);const n=s===-1?"2099-12-31 23:59:59":new Date(Date.now()+s*1e3).toISOString();return await e.env.DB.prepare(`
    ...
    `).bind(r,t,n,n).run(),e.json({success:!0,mutedUntil:n})}catch(r){return console.error("[PROFILE] Mute chat error:",r),e.json({error:"Failed to mute chat"},500)}});m.get("/api/profile/mute/:userId/:roomId",async e=>{try{const r=e.req.param("userId"),t=e.req.param("roomId"),s=await e.env.DB.prepare(`
      SELECT muted_until FROM muted_chats 
      WHERE user_id = ? AND room_id = ? AND muted_until > CURRENT_TIMESTAMP
    `).bind(r,t).first();return e.json({is_muted:!!s,isMuted:!!s,mutedUntil:(s==null?void 0:s.muted_until)||null})}catch(r){return console.error("[PROFILE] Check mute error:",r),e.json({error:"Failed to check mute status"},500)}});m.delete("/api/profile/mute/:userId/:roomId",async e=>{try{const r=e.req.param("userId"),t=e.req.param("roomId");return await e.env.DB.prepare(`
      DELETE FROM muted_chats WHERE user_id = ? AND room_id = ?
    `).bind(r,t).run(),e.json({success:!0})}catch(r){return console.error("[PROFILE] Unmute chat error:",r),e.json({error:"Failed to unmute chat"},500)}});m.get("/api/profile/media/:roomId",async e=>{try{const r=e.req.param("roomId"),t=e.req.query("type")||"all";let s="";t==="photos"?s="AND json_extract(file_metadata, '$.type') LIKE 'image/%'":t==="videos"?s="AND json_extract(file_metadata, '$.type') LIKE 'video/%'":t==="files"&&(s="AND json_extract(file_metadata, '$.type') NOT LIKE 'image/%' AND json_extract(file_metadata, '$.type') NOT LIKE 'video/%'");const n=await e.env.DB.prepare(`
      SELECT 
      ...
      ORDER BY m.created_at DESC
      LIMIT 100
    `).bind(r).all();return e.json({media:n.results||[]})}catch(r){return console.error("[PROFILE] Get media error:",r),e.json({error:"Failed to get media"},500)}});m.get("/api/profile/search/:roomId",async e=>{try{const r=e.req.param("roomId"),t=e.req.query("q")||"";if(!t||t.length<2)return e.json({results:[]});const s=await e.env.DB.prepare(`
      SELECT 
    ...
    `).bind(r,s,n,n).run(),e.json({success:!0}))}catch(r){return console.error("[PROFILE] Set permissions error:",r),e.json({error:"Failed to set permissions"},500)}});m.get("/api/profile/group/permissions/:roomId",async e=>{var r;try{const t=e.req.param("roomId"),s=await e.env.DB.prepare(`
      SELECT permission_type, permission_value 
      FROM group_permissions 
      WHERE room_id = ?
    `).bind(t).all(),n={messages:"everyone",add_members:"admins",edit_info:"admins"};return(r=s.results)==null||r.forEach(a=>{n[a.permission_type]=a.permission_value}),e.json({permissions:n})}catch(t){return console.error("[PROFILE] Get permissions error:",t),e.json({error:"Failed to get permissions"},500)}});m.post("/api/profile/group/privacy",async e=>{try{const{roomId:r,userId:t,privacy:s}=await e.req.json();if(!r||!t||!s)return e.json({error:"Missing required fields"},400);const n=await e.env.DB.prepare(`
      SELECT created_by FROM chat_rooms WHERE id = ?
    ...
    `).bind(s,r).run(),e.json({success:!0}))}catch(r){return console.error("[PROFILE] Set privacy error:",r),e.json({error:"Failed to set privacy"},500)}});m.post("/api/profile/report/user",async e=>{try{const{reporterId:r,reportedUserId:t,reason:s,description:n}=await e.req.json();if(!r||!t||!s)return e.json({error:"Missing required fields"},400);const a=crypto.randomUUID();return await e.env.DB.prepare(`
      INSERT INTO reports (id, reporter_id, reported_user_id, reason, description, status, created_at)
      VALUES (?, ?, ?, ?, ?, 'pending', CURRENT_TIMESTAMP)
    `).bind(a,r,t,s,n||null).run(),e.json({success:!0,reportId:a})}catch(r){return console.error("[PROFILE] Report user error:",r),e.json({error:"Failed to report user"},500)}});m.post("/api/profile/report/group",async e=>{try{const{reporterId:r,roomId:t,reason:s,description:n}=await e.req.json();if(!r||!t||!s)return e.json({error:"Missing required fields"},400);const a=crypto.randomUUID();return await e.env.DB.prepare(`
      INSERT INTO reports (id, reporter_id, reported_room_id, reason, description, status, created_at)
      VALUES (?, ?, ?, ?, ?, 'pending', CURRENT_TIMESTAMP)
    `).bind(a,r,t,s,n||null).run(),e.json({success:!0,reportId:a})}catch(r){return console.error("[PROFILE] Report group error:",r),e.json({error:"Failed to report group"},500)}});m.delete("/api/profile/clear/:userId/:roomId",async e=>{try{const r=e.req.param("userId"),t=e.req.param("roomId");return await e.env.DB.prepare(`
      INSERT INTO deleted_messages (user_id, message_id)
      SELECT ?, id FROM messages WHERE room_id = ?
    `).bind(r,t).run(),e.json({success:!0})}catch(r){return console.error("[PROFILE] Clear chat error:",r),e.json({error:"Failed to clear chat"},500)}});m.get("/api/profile/export/:roomId",async e=>{var r,t;try{const s=e.req.param("roomId");console.log(`[EXPORT] Exporting chat for room: ${s}`);const n=await e.env.DB.prepare(`
      SELECT 
