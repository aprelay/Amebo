var Tr=Object.defineProperty;var $e=e=>{throw TypeError(e)};var Dr=(e,r,t)=>r in e?Tr(e,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[r]=t;var g=(e,r,t)=>Dr(e,typeof r!="symbol"?r+"":r,t),Fe=(e,r,t)=>r.has(e)||$e("Cannot "+t);var l=(e,r,t)=>(Fe(e,r,"read from private field"),t?t.call(e):r.get(e)),v=(e,r,t)=>r.has(e)?$e("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,t),h=(e,r,t,s)=>(Fe(e,r,"write to private field"),s?s.call(e,t):r.set(e,t),t),b=(e,r,t)=>(Fe(e,r,"access private method"),t);var Ve=(e,r,t,s)=>({set _(n){h(e,r,n,t)},get _(){return l(e,r,s)}});var Ye=(e,r,t)=>(s,n)=>{let a=-1;return o(0);async function o(i){if(i<=a)throw new Error("next() called multiple times");a=i;let d,u=!1,c;if(e[i]?(c=e[i][0][0],s.req.routeIndex=i):c=i===e.length&&n||void 0,c)try{d=await c(s,()=>o(i+1))}catch(m){if(m instanceof Error&&r)s.error=m,d=await r(m,s),u=!0;else throw m}else s.finalized===!1&&t&&(d=await t(s));return d&&(s.finalized===!1||u)&&(s.res=d),s}},Sr=Symbol(),jr=async(e,r=Object.create(null))=>{const{all:t=!1,dot:s=!1}=r,a=(e instanceof dr?e.raw.headers:e.headers).get("Content-Type");return a!=null&&a.startsWith("multipart/form-data")||a!=null&&a.startsWith("application/x-www-form-urlencoded")?Ar(e,{all:t,dot:s}):{}};async function Ar(e,r){const t=await e.formData();return t?Or(t,r):{}}function Or(e,r){const t=Object.create(null);return e.forEach((s,n)=>{r.all||n.endsWith("[]")?kr(t,n,s):t[n]=s}),r.dot&&Object.entries(t).forEach(([s,n])=>{s.includes(".")&&(Cr(t,s,n),delete t[s])}),t}var kr=(e,r,t)=>{e[r]!==void 0?Array.isArray(e[r])?e[r].push(t):e[r]=[e[r],t]:r.endsWith("[]")?e[r]=[t]:e[r]=t},Cr=(e,r,t)=>{let s=e;const n=r.split(".");n.forEach((a,o)=>{o===n.length-1?s[a]=t:((!s[a]||typeof s[a]!="object"||Array.isArray(s[a])||s[a]instanceof File)&&(s[a]=Object.create(null)),s=s[a])})},sr=e=>{const r=e.split("/");return r[0]===""&&r.shift(),r},Nr=e=>{const{groups:r,path:t}=Ur(e),s=sr(t);return Lr(s,r)},Ur=e=>{const r=[];return e=e.replace(/\{[^}]+\}/g,(t,s)=>{const n=`@${s}`;return r.push([n,t]),n}),{groups:r,path:e}},Lr=(e,r)=>{for(let t=r.length-1;t>=0;t--){const[s]=r[t];for(let n=e.length-1;n>=0;n--)if(e[n].includes(s)){e[n]=e[n].replace(s,r[t][1]);break}}return e},Oe={},xr=(e,r)=>{if(e==="*")return"*";const t=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(t){const s=`${e}#${r}`;return Oe[s]||(t[2]?Oe[s]=r&&r[0]!==":"&&r[0]!=="*"?[s,t[1],new RegExp(`^${t[2]}(?=/${r})`)]:[e,t[1],new RegExp(`^${t[2]}$`)]:Oe[s]=[e,t[1],!0]),Oe[s]}return null},We=(e,r)=>{try{return r(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,t=>{try{return r(t)}catch{return t}})}},Pr=e=>We(e,decodeURI),nr=e=>{const r=e.url,t=r.indexOf("/",r.indexOf(":")+4);let s=t;for(;s<r.length;s++){const n=r.charCodeAt(s);if(n===37){const a=r.indexOf("?",s),o=r.slice(t,a===-1?void 0:a);return Pr(o.includes("%25")?o.replace(/%25/g,"%2525"):o)}else if(n===63)break}return r.slice(t,s)},Fr=e=>{const r=nr(e);return r.length>1&&r.at(-1)==="/"?r.slice(0,-1):r},le=(e,r,...t)=>(t.length&&(r=le(r,...t)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${r==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(r==null?void 0:r[0])==="/"?r.slice(1):r}`}`),ar=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const r=e.split("/"),t=[];let s="";return r.forEach(n=>{if(n!==""&&!/\:/.test(n))s+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){t.length===0&&s===""?t.push("/"):t.push(s);const a=n.replace("?","");s+="/"+a,t.push(s)}else s+="/"+n}),t.filter((n,a,o)=>o.indexOf(n)===a)},Me=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?We(e,ir):e):e,or=(e,r,t)=>{let s;if(!t&&r&&!/[%+]/.test(r)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(r,o+1)||(o=e.indexOf(`&${r}`,o+1));o!==-1;){const i=e.charCodeAt(o+r.length+1);if(i===61){const d=o+r.length+2,u=e.indexOf("&",d);return Me(e.slice(d,u===-1?void 0:u))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${r}`,o+1)}if(s=/[%+]/.test(e),!s)return}const n={};s??(s=/[%+]/.test(e));let a=e.indexOf("?",8);for(;a!==-1;){const o=e.indexOf("&",a+1);let i=e.indexOf("=",a);i>o&&o!==-1&&(i=-1);let d=e.slice(a+1,i===-1?o===-1?void 0:o:i);if(s&&(d=Me(d)),a=o,d==="")continue;let u;i===-1?u="":(u=e.slice(i+1,o===-1?void 0:o),s&&(u=Me(u))),t?(n[d]&&Array.isArray(n[d])||(n[d]=[]),n[d].push(u)):n[d]??(n[d]=u)}return r?n[r]:n},Mr=or,Br=(e,r)=>or(e,r,!0),ir=decodeURIComponent,Ge=e=>We(e,ir),fe,P,Y,ur,cr,He,G,Xe,dr=(Xe=class{constructor(e,r="/",t=[[]]){v(this,Y);g(this,"raw");v(this,fe);v(this,P);g(this,"routeIndex",0);g(this,"path");g(this,"bodyCache",{});v(this,G,e=>{const{bodyCache:r,raw:t}=this,s=r[e];if(s)return s;const n=Object.keys(r)[0];return n?r[n].then(a=>(n==="json"&&(a=JSON.stringify(a)),new Response(a)[e]())):r[e]=t[e]()});this.raw=e,this.path=r,h(this,P,t),h(this,fe,{})}param(e){return e?b(this,Y,ur).call(this,e):b(this,Y,cr).call(this)}query(e){return Mr(this.url,e)}queries(e){return Br(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const r={};return this.raw.headers.forEach((t,s)=>{r[s]=t}),r}async parseBody(e){var r;return(r=this.bodyCache).parsedBody??(r.parsedBody=await jr(this,e))}json(){return l(this,G).call(this,"text").then(e=>JSON.parse(e))}text(){return l(this,G).call(this,"text")}arrayBuffer(){return l(this,G).call(this,"arrayBuffer")}blob(){return l(this,G).call(this,"blob")}formData(){return l(this,G).call(this,"formData")}addValidatedData(e,r){l(this,fe)[e]=r}valid(e){return l(this,fe)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Sr](){return l(this,P)}get matchedRoutes(){return l(this,P)[0].map(([[,e]])=>e)}get routePath(){return l(this,P)[0].map(([[,e]])=>e)[this.routeIndex].path}},fe=new WeakMap,P=new WeakMap,Y=new WeakSet,ur=function(e){const r=l(this,P)[0][this.routeIndex][1][e],t=b(this,Y,He).call(this,r);return t&&/\%/.test(t)?Ge(t):t},cr=function(){const e={},r=Object.keys(l(this,P)[0][this.routeIndex][1]);for(const t of r){const s=b(this,Y,He).call(this,l(this,P)[0][this.routeIndex][1][t]);s!==void 0&&(e[t]=/\%/.test(s)?Ge(s):s)}return e},He=function(e){return l(this,P)[1]?l(this,P)[1][e]:e},G=new WeakMap,Xe),Hr={Stringify:1},lr=async(e,r,t,s,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const a=e.callbacks;return a!=null&&a.length?(n?n[0]+=e:n=[e],Promise.all(a.map(i=>i({phase:r,buffer:n,context:s}))).then(i=>Promise.all(i.filter(Boolean).map(d=>lr(d,r,!1,s,n))).then(()=>n[0]))):Promise.resolve(e)},qr="text/plain; charset=UTF-8",Be=(e,r)=>({"Content-Type":e,...r}),Ie,Te,q,Ee,W,C,De,he,ge,se,Se,je,K,pe,Qe,Wr=(Qe=class{constructor(e,r){v(this,K);v(this,Ie);v(this,Te);g(this,"env",{});v(this,q);g(this,"finalized",!1);g(this,"error");v(this,Ee);v(this,W);v(this,C);v(this,De);v(this,he);v(this,ge);v(this,se);v(this,Se);v(this,je);g(this,"render",(...e)=>(l(this,he)??h(this,he,r=>this.html(r)),l(this,he).call(this,...e)));g(this,"setLayout",e=>h(this,De,e));g(this,"getLayout",()=>l(this,De));g(this,"setRenderer",e=>{h(this,he,e)});g(this,"header",(e,r,t)=>{this.finalized&&h(this,C,new Response(l(this,C).body,l(this,C)));const s=l(this,C)?l(this,C).headers:l(this,se)??h(this,se,new Headers);r===void 0?s.delete(e):t!=null&&t.append?s.append(e,r):s.set(e,r)});g(this,"status",e=>{h(this,Ee,e)});g(this,"set",(e,r)=>{l(this,q)??h(this,q,new Map),l(this,q).set(e,r)});g(this,"get",e=>l(this,q)?l(this,q).get(e):void 0);g(this,"newResponse",(...e)=>b(this,K,pe).call(this,...e));g(this,"body",(e,r,t)=>b(this,K,pe).call(this,e,r,t));g(this,"text",(e,r,t)=>!l(this,se)&&!l(this,Ee)&&!r&&!t&&!this.finalized?new Response(e):b(this,K,pe).call(this,e,r,Be(qr,t)));g(this,"json",(e,r,t)=>b(this,K,pe).call(this,JSON.stringify(e),r,Be("application/json",t)));g(this,"html",(e,r,t)=>{const s=n=>b(this,K,pe).call(this,n,r,Be("text/html; charset=UTF-8",t));return typeof e=="object"?lr(e,Hr.Stringify,!1,{}).then(s):s(e)});g(this,"redirect",(e,r)=>{const t=String(e);return this.header("Location",/[^\x00-\xFF]/.test(t)?encodeURI(t):t),this.newResponse(null,r??302)});g(this,"notFound",()=>(l(this,ge)??h(this,ge,()=>new Response),l(this,ge).call(this,this)));h(this,Ie,e),r&&(h(this,W,r.executionCtx),this.env=r.env,h(this,ge,r.notFoundHandler),h(this,je,r.path),h(this,Se,r.matchResult))}get req(){return l(this,Te)??h(this,Te,new dr(l(this,Ie),l(this,je),l(this,Se))),l(this,Te)}get event(){if(l(this,W)&&"respondWith"in l(this,W))return l(this,W);throw Error("This context has no FetchEvent")}get executionCtx(){if(l(this,W))return l(this,W);throw Error("This context has no ExecutionContext")}get res(){return l(this,C)||h(this,C,new Response(null,{headers:l(this,se)??h(this,se,new Headers)}))}set res(e){if(l(this,C)&&e){e=new Response(e.body,e);for(const[r,t]of l(this,C).headers.entries())if(r!=="content-type")if(r==="set-cookie"){const s=l(this,C).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of s)e.headers.append("set-cookie",n)}else e.headers.set(r,t)}h(this,C,e),this.finalized=!0}get var(){return l(this,q)?Object.fromEntries(l(this,q)):{}}},Ie=new WeakMap,Te=new WeakMap,q=new WeakMap,Ee=new WeakMap,W=new WeakMap,C=new WeakMap,De=new WeakMap,he=new WeakMap,ge=new WeakMap,se=new WeakMap,Se=new WeakMap,je=new WeakMap,K=new WeakSet,pe=function(e,r,t){const s=l(this,C)?new Headers(l(this,C).headers):l(this,se)??new Headers;if(typeof r=="object"&&"headers"in r){const a=r.headers instanceof Headers?r.headers:new Headers(r.headers);for(const[o,i]of a)o.toLowerCase()==="set-cookie"?s.append(o,i):s.set(o,i)}if(t)for(const[a,o]of Object.entries(t))if(typeof o=="string")s.set(a,o);else{s.delete(a);for(const i of o)s.append(a,i)}const n=typeof r=="number"?r:(r==null?void 0:r.status)??l(this,Ee);return new Response(e,{status:n,headers:s})},Qe),T="ALL",$r="all",Vr=["get","post","put","delete","options","patch"],pr="Can not add a route since the matcher is already built.",mr=class extends Error{},Yr="__COMPOSED_HANDLER",Gr=e=>e.text("404 Not Found",404),Ke=(e,r)=>{if("getResponse"in e){const t=e.getResponse();return r.newResponse(t.body,t)}return console.error(e),r.text("Internal Server Error",500)},F,D,fr,M,re,ke,Ce,_e,Kr=(_e=class{constructor(r={}){v(this,D);g(this,"get");g(this,"post");g(this,"put");g(this,"delete");g(this,"options");g(this,"patch");g(this,"all");g(this,"on");g(this,"use");g(this,"router");g(this,"getPath");g(this,"_basePath","/");v(this,F,"/");g(this,"routes",[]);v(this,M,Gr);g(this,"errorHandler",Ke);g(this,"onError",r=>(this.errorHandler=r,this));g(this,"notFound",r=>(h(this,M,r),this));g(this,"fetch",(r,...t)=>b(this,D,Ce).call(this,r,t[1],t[0],r.method));g(this,"request",(r,t,s,n)=>r instanceof Request?this.fetch(t?new Request(r,t):r,s,n):(r=r.toString(),this.fetch(new Request(/^https?:\/\//.test(r)?r:`http://localhost${le("/",r)}`,t),s,n)));g(this,"fire",()=>{addEventListener("fetch",r=>{r.respondWith(b(this,D,Ce).call(this,r.request,r,void 0,r.request.method))})});[...Vr,$r].forEach(a=>{this[a]=(o,...i)=>(typeof o=="string"?h(this,F,o):b(this,D,re).call(this,a,l(this,F),o),i.forEach(d=>{b(this,D,re).call(this,a,l(this,F),d)}),this)}),this.on=(a,o,...i)=>{for(const d of[o].flat()){h(this,F,d);for(const u of[a].flat())i.map(c=>{b(this,D,re).call(this,u.toUpperCase(),l(this,F),c)})}return this},this.use=(a,...o)=>(typeof a=="string"?h(this,F,a):(h(this,F,"*"),o.unshift(a)),o.forEach(i=>{b(this,D,re).call(this,T,l(this,F),i)}),this);const{strict:s,...n}=r;Object.assign(this,n),this.getPath=s??!0?r.getPath??nr:Fr}route(r,t){const s=this.basePath(r);return t.routes.map(n=>{var o;let a;t.errorHandler===Ke?a=n.handler:(a=async(i,d)=>(await Ye([],t.errorHandler)(i,()=>n.handler(i,d))).res,a[Yr]=n.handler),b(o=s,D,re).call(o,n.method,n.path,a)}),this}basePath(r){const t=b(this,D,fr).call(this);return t._basePath=le(this._basePath,r),t}mount(r,t,s){let n,a;s&&(typeof s=="function"?a=s:(a=s.optionHandler,s.replaceRequest===!1?n=d=>d:n=s.replaceRequest));const o=a?d=>{const u=a(d);return Array.isArray(u)?u:[u]}:d=>{let u;try{u=d.executionCtx}catch{}return[d.env,u]};n||(n=(()=>{const d=le(this._basePath,r),u=d==="/"?0:d.length;return c=>{const m=new URL(c.url);return m.pathname=m.pathname.slice(u)||"/",new Request(m,c)}})());const i=async(d,u)=>{const c=await t(n(d.req.raw),...o(d));if(c)return c;await u()};return b(this,D,re).call(this,T,le(r,"*"),i),this}},F=new WeakMap,D=new WeakSet,fr=function(){const r=new _e({router:this.router,getPath:this.getPath});return r.errorHandler=this.errorHandler,h(r,M,l(this,M)),r.routes=this.routes,r},M=new WeakMap,re=function(r,t,s){r=r.toUpperCase(),t=le(this._basePath,t);const n={basePath:this._basePath,path:t,method:r,handler:s};this.router.add(r,t,[s,n]),this.routes.push(n)},ke=function(r,t){if(r instanceof Error)return this.errorHandler(r,t);throw r},Ce=function(r,t,s,n){if(n==="HEAD")return(async()=>new Response(null,await b(this,D,Ce).call(this,r,t,s,"GET")))();const a=this.getPath(r,{env:s}),o=this.router.match(n,a),i=new Wr(r,{path:a,matchResult:o,env:s,executionCtx:t,notFoundHandler:l(this,M)});if(o[0].length===1){let u;try{u=o[0][0][0][0](i,async()=>{i.res=await l(this,M).call(this,i)})}catch(c){return b(this,D,ke).call(this,c,i)}return u instanceof Promise?u.then(c=>c||(i.finalized?i.res:l(this,M).call(this,i))).catch(c=>b(this,D,ke).call(this,c,i)):u??l(this,M).call(this,i)}const d=Ye(o[0],this.errorHandler,l(this,M));return(async()=>{try{const u=await d(i);if(!u.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return u.res}catch(u){return b(this,D,ke).call(this,u,i)}})()},_e),Er=[];function Jr(e,r){const t=this.buildAllMatchers(),s=((n,a)=>{const o=t[n]||t[T],i=o[2][a];if(i)return i;const d=a.match(o[0]);if(!d)return[[],Er];const u=d.indexOf("",1);return[o[1][u],d]});return this.match=s,s(e,r)}var Ue="[^/]+",be=".*",Re="(?:|/.*)",me=Symbol(),zr=new Set(".\\+*[^]$()");function Xr(e,r){return e.length===1?r.length===1?e<r?-1:1:-1:r.length===1||e===be||e===Re?1:r===be||r===Re?-1:e===Ue?1:r===Ue?-1:e.length===r.length?e<r?-1:1:r.length-e.length}var ne,ae,B,de,Qr=(de=class{constructor(){v(this,ne);v(this,ae);v(this,B,Object.create(null))}insert(r,t,s,n,a){if(r.length===0){if(l(this,ne)!==void 0)throw me;if(a)return;h(this,ne,t);return}const[o,...i]=r,d=o==="*"?i.length===0?["","",be]:["","",Ue]:o==="/*"?["","",Re]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let u;if(d){const c=d[1];let m=d[2]||Ue;if(c&&d[2]&&(m===".*"||(m=m.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(m))))throw me;if(u=l(this,B)[m],!u){if(Object.keys(l(this,B)).some(f=>f!==be&&f!==Re))throw me;if(a)return;u=l(this,B)[m]=new de,c!==""&&h(u,ae,n.varIndex++)}!a&&c!==""&&s.push([c,l(u,ae)])}else if(u=l(this,B)[o],!u){if(Object.keys(l(this,B)).some(c=>c.length>1&&c!==be&&c!==Re))throw me;if(a)return;u=l(this,B)[o]=new de}u.insert(i,t,s,n,a)}buildRegExpStr(){const t=Object.keys(l(this,B)).sort(Xr).map(s=>{const n=l(this,B)[s];return(typeof l(n,ae)=="number"?`(${s})@${l(n,ae)}`:zr.has(s)?`\\${s}`:s)+n.buildRegExpStr()});return typeof l(this,ne)=="number"&&t.unshift(`#${l(this,ne)}`),t.length===0?"":t.length===1?t[0]:"(?:"+t.join("|")+")"}},ne=new WeakMap,ae=new WeakMap,B=new WeakMap,de),Le,Ae,Ze,Zr=(Ze=class{constructor(){v(this,Le,{varIndex:0});v(this,Ae,new Qr)}insert(e,r,t){const s=[],n=[];for(let o=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,d=>{const u=`@\\${o}`;return n[o]=[u,d],o++,i=!0,u}),!i)break}const a=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=n.length-1;o>=0;o--){const[i]=n[o];for(let d=a.length-1;d>=0;d--)if(a[d].indexOf(i)!==-1){a[d]=a[d].replace(i,n[o][1]);break}}return l(this,Ae).insert(a,r,s,l(this,Le),t),s}buildRegExp(){let e=l(this,Ae).buildRegExpStr();if(e==="")return[/^$/,[],[]];let r=0;const t=[],s=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,a,o)=>a!==void 0?(t[++r]=Number(a),"$()"):(o!==void 0&&(s[Number(o)]=++r),"")),[new RegExp(`^${e}`),t,s]}},Le=new WeakMap,Ae=new WeakMap,Ze),et=[/^$/,[],Object.create(null)],Ne=Object.create(null);function hr(e){return Ne[e]??(Ne[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(r,t)=>t?`\\${t}`:"(?:|/.*)")}$`))}function rt(){Ne=Object.create(null)}function tt(e){var u;const r=new Zr,t=[];if(e.length===0)return et;const s=e.map(c=>[!/\*|\/:/.test(c[0]),...c]).sort(([c,m],[f,E])=>c?1:f?-1:m.length-E.length),n=Object.create(null);for(let c=0,m=-1,f=s.length;c<f;c++){const[E,_,w]=s[c];E?n[_]=[w.map(([R])=>[R,Object.create(null)]),Er]:m++;let y;try{y=r.insert(_,m,E)}catch(R){throw R===me?new mr(_):R}E||(t[m]=w.map(([R,k])=>{const S=Object.create(null);for(k-=1;k>=0;k--){const[U,I]=y[k];S[U]=I}return[R,S]}))}const[a,o,i]=r.buildRegExp();for(let c=0,m=t.length;c<m;c++)for(let f=0,E=t[c].length;f<E;f++){const _=(u=t[c][f])==null?void 0:u[1];if(!_)continue;const w=Object.keys(_);for(let y=0,R=w.length;y<R;y++)_[w[y]]=i[_[w[y]]]}const d=[];for(const c in o)d[c]=t[o[c]];return[a,d,n]}function ce(e,r){if(e){for(const t of Object.keys(e).sort((s,n)=>n.length-s.length))if(hr(t).test(r))return[...e[t]]}}var J,z,xe,gr,er,st=(er=class{constructor(){v(this,xe);g(this,"name","RegExpRouter");v(this,J);v(this,z);g(this,"match",Jr);h(this,J,{[T]:Object.create(null)}),h(this,z,{[T]:Object.create(null)})}add(e,r,t){var i;const s=l(this,J),n=l(this,z);if(!s||!n)throw new Error(pr);s[e]||[s,n].forEach(d=>{d[e]=Object.create(null),Object.keys(d[T]).forEach(u=>{d[e][u]=[...d[T][u]]})}),r==="/*"&&(r="*");const a=(r.match(/\/:/g)||[]).length;if(/\*$/.test(r)){const d=hr(r);e===T?Object.keys(s).forEach(u=>{var c;(c=s[u])[r]||(c[r]=ce(s[u],r)||ce(s[T],r)||[])}):(i=s[e])[r]||(i[r]=ce(s[e],r)||ce(s[T],r)||[]),Object.keys(s).forEach(u=>{(e===T||e===u)&&Object.keys(s[u]).forEach(c=>{d.test(c)&&s[u][c].push([t,a])})}),Object.keys(n).forEach(u=>{(e===T||e===u)&&Object.keys(n[u]).forEach(c=>d.test(c)&&n[u][c].push([t,a]))});return}const o=ar(r)||[r];for(let d=0,u=o.length;d<u;d++){const c=o[d];Object.keys(n).forEach(m=>{var f;(e===T||e===m)&&((f=n[m])[c]||(f[c]=[...ce(s[m],c)||ce(s[T],c)||[]]),n[m][c].push([t,a-u+d+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(l(this,z)).concat(Object.keys(l(this,J))).forEach(r=>{e[r]||(e[r]=b(this,xe,gr).call(this,r))}),h(this,J,h(this,z,void 0)),rt(),e}},J=new WeakMap,z=new WeakMap,xe=new WeakSet,gr=function(e){const r=[];let t=e===T;return[l(this,J),l(this,z)].forEach(s=>{const n=s[e]?Object.keys(s[e]).map(a=>[a,s[e][a]]):[];n.length!==0?(t||(t=!0),r.push(...n)):e!==T&&r.push(...Object.keys(s[T]).map(a=>[a,s[T][a]]))}),t?tt(r):null},er),X,$,rr,nt=(rr=class{constructor(e){g(this,"name","SmartRouter");v(this,X,[]);v(this,$,[]);h(this,X,e.routers)}add(e,r,t){if(!l(this,$))throw new Error(pr);l(this,$).push([e,r,t])}match(e,r){if(!l(this,$))throw new Error("Fatal error");const t=l(this,X),s=l(this,$),n=t.length;let a=0,o;for(;a<n;a++){const i=t[a];try{for(let d=0,u=s.length;d<u;d++)i.add(...s[d]);o=i.match(e,r)}catch(d){if(d instanceof mr)continue;throw d}this.match=i.match.bind(i),h(this,X,[i]),h(this,$,void 0);break}if(a===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(l(this,$)||l(this,X).length!==1)throw new Error("No active router has been determined yet.");return l(this,X)[0]}},X=new WeakMap,$=new WeakMap,rr),ve=Object.create(null),Q,O,oe,ye,j,V,te,we,at=(we=class{constructor(r,t,s){v(this,V);v(this,Q);v(this,O);v(this,oe);v(this,ye,0);v(this,j,ve);if(h(this,O,s||Object.create(null)),h(this,Q,[]),r&&t){const n=Object.create(null);n[r]={handler:t,possibleKeys:[],score:0},h(this,Q,[n])}h(this,oe,[])}insert(r,t,s){h(this,ye,++Ve(this,ye)._);let n=this;const a=Nr(t),o=[];for(let i=0,d=a.length;i<d;i++){const u=a[i],c=a[i+1],m=xr(u,c),f=Array.isArray(m)?m[0]:u;if(f in l(n,O)){n=l(n,O)[f],m&&o.push(m[1]);continue}l(n,O)[f]=new we,m&&(l(n,oe).push(m),o.push(m[1])),n=l(n,O)[f]}return l(n,Q).push({[r]:{handler:s,possibleKeys:o.filter((i,d,u)=>u.indexOf(i)===d),score:l(this,ye)}}),n}search(r,t){var d;const s=[];h(this,j,ve);let a=[this];const o=sr(t),i=[];for(let u=0,c=o.length;u<c;u++){const m=o[u],f=u===c-1,E=[];for(let _=0,w=a.length;_<w;_++){const y=a[_],R=l(y,O)[m];R&&(h(R,j,l(y,j)),f?(l(R,O)["*"]&&s.push(...b(this,V,te).call(this,l(R,O)["*"],r,l(y,j))),s.push(...b(this,V,te).call(this,R,r,l(y,j)))):E.push(R));for(let k=0,S=l(y,oe).length;k<S;k++){const U=l(y,oe)[k],I=l(y,j)===ve?{}:{...l(y,j)};if(U==="*"){const A=l(y,O)["*"];A&&(s.push(...b(this,V,te).call(this,A,r,l(y,j))),h(A,j,I),E.push(A));continue}const[Z,ee,L]=U;if(!m&&!(L instanceof RegExp))continue;const N=l(y,O)[Z],x=o.slice(u).join("/");if(L instanceof RegExp){const A=L.exec(x);if(A){if(I[ee]=A[0],s.push(...b(this,V,te).call(this,N,r,l(y,j),I)),Object.keys(l(N,O)).length){h(N,j,I);const H=((d=A[0].match(/\//))==null?void 0:d.length)??0;(i[H]||(i[H]=[])).push(N)}continue}}(L===!0||L.test(m))&&(I[ee]=m,f?(s.push(...b(this,V,te).call(this,N,r,I,l(y,j))),l(N,O)["*"]&&s.push(...b(this,V,te).call(this,l(N,O)["*"],r,I,l(y,j)))):(h(N,j,I),E.push(N)))}}a=E.concat(i.shift()??[])}return s.length>1&&s.sort((u,c)=>u.score-c.score),[s.map(({handler:u,params:c})=>[u,c])]}},Q=new WeakMap,O=new WeakMap,oe=new WeakMap,ye=new WeakMap,j=new WeakMap,V=new WeakSet,te=function(r,t,s,n){const a=[];for(let o=0,i=l(r,Q).length;o<i;o++){const d=l(r,Q)[o],u=d[t]||d[T],c={};if(u!==void 0&&(u.params=Object.create(null),a.push(u),s!==ve||n&&n!==ve))for(let m=0,f=u.possibleKeys.length;m<f;m++){const E=u.possibleKeys[m],_=c[u.score];u.params[E]=n!=null&&n[E]&&!_?n[E]:s[E]??(n==null?void 0:n[E]),c[u.score]=!0}}return a},we),ie,tr,ot=(tr=class{constructor(){g(this,"name","TrieRouter");v(this,ie);h(this,ie,new at)}add(e,r,t){const s=ar(r);if(s){for(let n=0,a=s.length;n<a;n++)l(this,ie).insert(e,s[n],t);return}l(this,ie).insert(e,r,t)}match(e,r){return l(this,ie).search(e,r)}},ie=new WeakMap,tr),_r=class extends Kr{constructor(e={}){super(e),this.router=e.router??new nt({routers:[new st,new ot]})}},it=e=>{const t={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},s=(a=>typeof a=="string"?a==="*"?()=>a:o=>a===o?o:null:typeof a=="function"?a:o=>a.includes(o)?o:null)(t.origin),n=(a=>typeof a=="function"?a:Array.isArray(a)?()=>a:()=>[])(t.allowMethods);return async function(o,i){var c;function d(m,f){o.res.headers.set(m,f)}const u=await s(o.req.header("origin")||"",o);if(u&&d("Access-Control-Allow-Origin",u),t.credentials&&d("Access-Control-Allow-Credentials","true"),(c=t.exposeHeaders)!=null&&c.length&&d("Access-Control-Expose-Headers",t.exposeHeaders.join(",")),o.req.method==="OPTIONS"){t.origin!=="*"&&d("Vary","Origin"),t.maxAge!=null&&d("Access-Control-Max-Age",t.maxAge.toString());const m=await n(o.req.header("origin")||"",o);m.length&&d("Access-Control-Allow-Methods",m.join(","));let f=t.allowHeaders;if(!(f!=null&&f.length)){const E=o.req.header("Access-Control-Request-Headers");E&&(f=E.split(/\s*,\s*/))}return f!=null&&f.length&&(d("Access-Control-Allow-Headers",f.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await i(),t.origin!=="*"&&o.header("Vary","Origin",{append:!0})}},dt=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,Je=(e,r=ct)=>{const t=/\.([a-zA-Z0-9]+?)$/,s=e.match(t);if(!s)return;let n=r[s[1]];return n&&n.startsWith("text")&&(n+="; charset=utf-8"),n},ut={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},ct=ut,lt=(...e)=>{let r=e.filter(n=>n!=="").join("/");r=r.replace(new RegExp("(?<=\\/)\\/+","g"),"");const t=r.split("/"),s=[];for(const n of t)n===".."&&s.length>0&&s.at(-1)!==".."?s.pop():n!=="."&&s.push(n);return s.join("/")||"."},yr={br:".br",zstd:".zst",gzip:".gz"},pt=Object.keys(yr),mt="index.html",ft=e=>{const r=e.root??"./",t=e.path,s=e.join??lt;return async(n,a)=>{var c,m,f,E;if(n.finalized)return a();let o;if(e.path)o=e.path;else try{if(o=decodeURIComponent(n.req.path),/(?:^|[\/\\])\.\.(?:$|[\/\\])/.test(o))throw new Error}catch{return await((c=e.onNotFound)==null?void 0:c.call(e,n.req.path,n)),a()}let i=s(r,!t&&e.rewriteRequestPath?e.rewriteRequestPath(o):o);e.isDir&&await e.isDir(i)&&(i=s(i,mt));const d=e.getContent;let u=await d(i,n);if(u instanceof Response)return n.newResponse(u.body,u);if(u){const _=e.mimes&&Je(i,e.mimes)||Je(i);if(n.header("Content-Type",_||"application/octet-stream"),e.precompressed&&(!_||dt.test(_))){const w=new Set((m=n.req.header("Accept-Encoding"))==null?void 0:m.split(",").map(y=>y.trim()));for(const y of pt){if(!w.has(y))continue;const R=await d(i+yr[y],n);if(R){u=R,n.header("Content-Encoding",y),n.header("Vary","Accept-Encoding",{append:!0});break}}}return await((f=e.onFound)==null?void 0:f.call(e,i,n)),n.body(u)}await((E=e.onNotFound)==null?void 0:E.call(e,i,n)),await a()}},Et=async(e,r)=>{let t;r&&r.manifest?typeof r.manifest=="string"?t=JSON.parse(r.manifest):t=r.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?t=JSON.parse(__STATIC_CONTENT_MANIFEST):t=__STATIC_CONTENT_MANIFEST;let s;r&&r.namespace?s=r.namespace:s=__STATIC_CONTENT;const n=t[e]||e;if(!n)return null;const a=await s.get(n,{type:"stream"});return a||null},ht=e=>async function(t,s){return ft({...e,getContent:async a=>Et(a,{manifest:e.manifest,namespace:e.namespace?e.namespace:t.env?t.env.__STATIC_CONTENT:void 0})})(t,s)},gt=e=>ht(e);async function _t(e,r,t,s,n){const a={typ:"JWT",alg:"HS256",cty:"twilio-fpa;v=1"},o=Math.floor(Date.now()/1e3),i=o+3600,d={room:n},u={jti:`${r}-${o}`,iss:r,sub:e,exp:i,grants:{identity:s,video:d}},c=U=>{const I=JSON.stringify(U);return btoa(I).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")},m=c(a),f=c(u),E=`${m}.${f}`,_=new TextEncoder,w=_.encode(t),y=await crypto.subtle.importKey("raw",w,{name:"HMAC",hash:"SHA-256"},!1,["sign"]),R=await crypto.subtle.sign("HMAC",y,_.encode(E)),k=new Uint8Array(R);let S=btoa(String.fromCharCode(...k));return S=S.replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,""),`${E}.${S}`}const p=new _r;p.use("/api/*",it());p.use("/static/*",gt({root:"./public"}));async function wr(e,r,t,s,n){try{const a=`${t}/verify-email?token=${r}`,o=await fetch("https://api.resend.com/emails",{method:"POST",headers:{Authorization:`Bearer ${s}`,"Content-Type":"application/json"},body:JSON.stringify({from:`Amebo <${n}>`,to:e,subject:"Verify your Amebo account",html:`
  ...
  `).bind(r,n).first();a||(await e.prepare(`
    ...
    `).bind(t).first();if(!I)return e.json({error:"Recipient not found"},404);console.log(`[TOKEN GIFT] ${S.username} sending ${s} tokens to ${I.username} (Weekly: ${w+s}/${E})`);const Z=await e.env.DB.prepare(`
    ...
    `).bind(L,r,t,s,n||null,a||null).run(),console.log(`[TOKEN GIFT] Transaction recorded: ${L}`);const N=crypto.randomUUID();await e.env.DB.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?)
    `).bind(N,t,"token_gift","🎁 Token Gift Received!",`${S.username} sent you ${s} tokens${a?": "+a:""}`,JSON.stringify({fromUserId:r,amount:s,message:a,transactionId:L})).run(),console.log("[TOKEN GIFT] Notification created for receiver");const x=w+s;await e.env.DB.prepare(`
    ...
    `).bind(x,r,m).run(),console.log(`[WEEKLY GIFT TRACKING] Updated: ${x}/${E} tokens gifted this week`),await e.env.DB.prepare(`
      INSERT INTO weekly_gift_history (user_id, year_week, amount, recipient_id, total_gifted_after, limit_value, exceeded)
      VALUES (?, ?, ?, ?, ?, ?, 0)
    `).bind(r,m,s,t,x,E).run();const A=U-s,H=(I.tokens||0)+s,ue=E-x;let Pe="";return ue<=30&&ue>0?Pe=` ⚠️ Only ${ue} tokens remaining this week!`:ue===0&&(Pe=" 🚫 Weekly gift limit reached!"),e.json({success:!0,message:`Successfully sent ${s} tokens to ${I.username}${Pe}`,transactionId:L,newBalance:A,receiverUsername:I.username,receiverBalance:H,fromUsername:S.username,weeklyGifted:x,weeklyLimit:E,weeklyRemaining:ue})}catch(r){return console.error("Gift tokens error:",r),e.json({error:"Failed to gift tokens",details:r.message},500)}});p.get("/api/tokens/weekly-gift-status/:userId",async e=>{try{const r=e.req.param("userId"),t=new Date,s=new Date(t.getFullYear(),0,1),n=Math.floor((t.getTime()-s.getTime())/(1440*60*1e3)),a=Math.ceil((n+s.getDay()+1)/7),o=`${t.getFullYear()}-${String(a).padStart(2,"0")}`,i=await e.env.DB.prepare(`
      SELECT config_value FROM weekly_gift_config WHERE config_name = 'weekly_gift_limit' AND is_active = 1
